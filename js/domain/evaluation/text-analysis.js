...
const POLE_MARKERS = {
  ...
  S: {
    ...
    summary:
      "في هذا القطب يجب قراءة الوثيقة ومقارنتها واستخراج الاستنتاج، لا القفز مباشرة إلى التفسير السببي."
  },
  E: {
...
const CONCEPT_ALIASES = {
  تركيب: ["اصطناع", "تخليق"],
  اصطناع: ["تركيب", "تخليق"],
  بروتين: ["بروتينات", "عديدات الببتيد", "سلسلة ببتيدية", "ببتيد", "جزيئة بروتينية", "هيكلة فراغية", "بنية فراغية"],
