/* ============================================================
   DECISIONS & DRILL — قرارا البداية + تدريب القرار (تدريب 60 ثانية)
   ------------------------------------------------------------
   القرار قبل الكتابة لا أثناءها (MIFTAH v3.1):
     القرار 1: سند أم معارف؟
     القرار 2: وصف أم تفسير؟
   التدريب يقتني 12 تعليمة في كل جولة؛ شرط الخروج: 12/12
   ثلاث مرات متتالية ← يُفتح المستوى المتقدم.
...
export const DRILL_BANK = [
  {
    ...
    source: "doc",
    gate2: "image",
    note: "فعل استخراج مع سند مذكور: وصف أو تحليل دون تفسير."
  },
  {
  ...
  },
  {
    ...
    gate2: "film",
    twoColumns: true,
    note: "سند مع المعارف: مسودة بعمودين [من الوثيقة | من الدرس]، ثم تفسير."
  },
  {
    text: "عرّف الإنزيم.",
    source: "memory",
  ...
  },
  {
    ...
    source: "doc",
    gate2: "image",
    note: "المنحنى سند وثائقي، والمطلوب وصف بمجالات وقيم."
  },
  {
    text: "استخرج من الجدول قيمة التركيز النهائي عند 20 دقيقة.",
    source: "doc",
    gate2: "image",
    note: "استخراج مباشر من جدول: رقم ووحدة."
  },
  {
    text: "علّل النتيجة المسجلة في الوثيقة.",
    source: "doc",
    gate2: "film",
    note: "التعليل يطلب ملاحظة ثم سبباً وآلية؛ استخدم الخطوات الأربع."
  },
  {
    text: "سمّ المراحل المرقمة من 1 إلى 3 على الرسم.",
    source: "doc",
    gate2: "image",
    note: "تسمية عناصر رسم: أسماء دقيقة دون شرح."
  },
  {
    text: "قارن بين النمطين الظاهريين السليم والمصاب وفق الجدول.",
    source: "doc",
    gate2: "image",
    note: "مقارنة متوازية وفق جدول باستعمال «بينما» أو «في حين»."
  },
  {
    text: "استنتج دور الأنسولين بالاعتماد على معطيات الوثيقتين.",
    source: "doc",
    gate2: "film",
    note: "استنتاج من سند: ابدأ بالمعطيات ثم اكتب النتيجة."
  },
  {
  ...
  },
  {
    ...
    source: "doc",
    gate2: "film",
    note: "«كيف» تطلب آلية وسلسلة سببية كاملة."
  },
  {
    text: "فسّر آلية عمل الجيلاكوزيداز في العصارة المعوية بالاستعانة بالوثيقة.",
    source: "doc",
    gate2: "film",
    note: "تفسير آلية بسند: من الوثيقة ثم الآلية من الدرس."
  },
  {
    text: "حدّد المتغير المستقل والمتغير التابع في التجربة الموضحة بالشكل.",
    source: "doc",
    gate2: "image",
    note: "تحديد من شكل: تسمية صريحة للمتغيرين."
  },
  {
    text: "اشرح كيف تمنع الخلايا القاتلة الطبيعية انتشار الورم.",
    source: "memory",
    gate2: null,
    note: "لا سند مذكور: أجب من المعارف ثم اختم، حتى إن كان الفعل تفسيرياً."
  },
  {
    text: "وضّح بالرسم التحولات التي مرّ بها الجرثوم.",
    source: "doc",
    gate2: "image",
    note: "إنجاز رسم انطلاقاً من سند: حافظ على عناصر السند فقط."
  }
];
