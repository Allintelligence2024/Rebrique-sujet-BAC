...
- Tests exécutés par `npm test` : **257** (comptage statique des `test()` déclarés dans `tests/*.test.mjs`, boucle `BENCHMARK_CASES` comprise)
...
- Taille de la façade UI (js/ui.js) : **462 lignes**
