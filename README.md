...
Pages 1, 3, 4 et 5 relues sur le scan local (2026-09-16) et pages 2, 6, 7 et 10 sur
photos du sujet officiel (2026-08-31) : **15 pôles sur 24** du sujet sont `official`.
Le reste (pages 8–9 et cadrages N/W) reste `reconstructed` :
...
- Tests exécutés par `npm test` : **355** (comptage statique des `test()` déclarés dans `tests/*.test.mjs`, boucle `BENCHMARK_CASES` comprise)
- Copies vérifiées dans le hard benchmark : **0/3765 minimum** avant toute promotion numérique
