...
test("le statut P1 refuse un faux 100 % tant que les inventaires et copies manquent", () => {
  ...
  /* 5595 = 373 consignes officielles × 15 copies (3195 jusqu'au 2026-09-19 ;
     3915 avec les 48 consignes OCR Maths ; 4155 avec les 16 consignes OCR de
     SE 2021 ; 4515 avec SE 2013 vérifiée ; 4875 avec SE 2014 vérifiée ; 5235 avec SE 2015 ; 5595 avec SE 2016). */
  assert.match(byId["P1.5"].evidence, /0\/5595 copies/);
