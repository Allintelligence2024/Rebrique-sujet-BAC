...
const ENABLED_RECON_SE_REMAINING = ["2019", "2018", "2017", "2016"];
const OFFICIAL_VERIFIED_SE = ["2015", "2014", "2013"];
...
test("les consignes de l'archive 2016-2019 sont toutes marquées reconstructed — 2013-2015 sont désormais official", () => {
...
test("aucune consigne d'archive 2016-2019 n'est marquée official — 2013-2015 sont official", () => {
  for (const year of ARCHIVE_YEARS) {
