...
## P1.1 / P1.2 — 52 inventaires officiels

Pour chacun des 52 couples année/sujet inventoriés :
...
Le périmètre numérique actuel contient 236 pôles dont la consigne est marquée officielle. La politique exige au minimum 15 copies par pôle : **3 540 réponses réelles** au minimum, chacune avec :
