...
- **`subjects.js` (303 L.)** : `normalizeArabic` (L.11-31), `stripArabicClitics` avec liste de radicaux protégés (L.37-75, correctif #68), `EXAM_MINUTES_BY_STREAM {se:270, m:150}` (L.77-80), `YEAR_CATALOG` **19 entrées au 2026-09-12 — 28 aujourd'hui** (14 maths + 14 sciences ; snapshot : L.95-204), `YEAR_LOADERS` **19 chargeurs littéraux (28 aujourd'hui**, L.284+)**, `validateLoadedYear` (L.234-251 : id, stream, nombre de sujets, nombre d'exercices), `loadYear` avec promesse partagée (L.259-279).
  ...
  ✅ **2021 SE : armature assumée** (au 2026-09-12, « aucun chargeur ») — le chargeur existe désormais (`data/years/se/year-2021.js`) mais l'année ne contient **que** la structure lue dans le PDF (2 sujets × 3 exercices, barème 5 + 7 + 8) et les thèmes : aucune consigne, `poles: {}`, donc réponse en copie libre. Le fichier documente pourquoi (couche texte illisible : 1 consigne officielle retrouvée sur 77) — cohérent avec `data/archive.js`, qui garde 2021 SE en consultation et l'exclut de la simulation.
