          ...
          poles: {
            ...
            S: {
              ...
              rule: {
                ...
                keywords: ["استطالة", "ريبوزوم", "ببتيدية"],
                minHits: 2,
                forbidden: []
              }
            },
            E: {
              ...
              rule: {
                ...
                keywords: ["ريبوزوم", "استطالة", "ببتيدية", "بكتيريا"],
                minHits: 3,
                forbidden: []
              }
            },
      ...
      exercises: [
        {
          ...
          poles: {
            ...
            S: {
              ...
              minLength: 40,
              modelAnswer:
                "تتعرف الخلية البالعة على الببتيد المستضدي المحمول على HLA II. 5 TCR. 6 مستقبل. 7 جسم مضاد. 8 معقد مناعي. تبتلع المستضد وتهضمه بواسطة الأنزيمات الهاضمة منتجة الببتيد المستضدي ثم تثبته على المعقد على غشائها وتقدمه لـ LT4 بالتماس لتنشيطها. تثبت المعقد المناعي على المستقبلات الغشائية المتكاملة مع منطقة التثبيت في الجسم المضاد للتخلص منه.",
              rule: {
                prompt: "تعرف على البيانات ودور البالعة",
                keywords: ["بالعة", "معقد", "مضاد", "HLA"],
                minHits: 3,
                forbidden: []
              }
            },
