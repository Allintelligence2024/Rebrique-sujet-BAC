          ...
          poles: {
            N: {
              ...
              rule: {
                ...
                keywords: ["وراثة", "تعبير", "ريبوزوم", "نواة"],
                minHits: 2,
                forbidden: []
              }
            },
            ...
            E: {
              ...
              rule: {
                ...
                keywords: ["مورثة", "ARNm", "ترجمة", "بروتين"],
                minHits: 3,
                forbidden: []
              }
            },
          ...
          poles: {
            ...
            S: {
              ...
              rule: {
                ...
                keywords: ["شحنة", "خلايا", "تناقص", "تزايد"],
                minHits: 3,
                forbidden: []
              }
            },
            E: {
              ...
              rule: {
                ...
                keywords: ["CMH", "أنترلوكين", "خلايا", "استجابة"],
                minHits: 3,
                forbidden: []
              }
            },
            W: {
              ...
              minLength: 110,
              modelAnswer:
                "يتضمن النص النقاط التالية: استهداف فيروس VIH للخلايا LT4 التي تنشط بعد تعرّفها على الببتيد المستضدي المعروض مرتبطا بالـ CMH II من الخلية العارضة بواسطة مستقبلها الغشائي TCR بفضل التكامل البنيوي. اكتساب الـ LT4 نتيجة تنشيطها القدرة على إنتاج وإفراز الأنترلوكين 2. تحفيز الأنترلوكين 2 للخلايا اللمفاوية المحسّسة (LB.LT) على التكاثر والتمايز إلى خلايا مناعية منفّذة (البلازمية، LTH، LTC). استهداف الـ VIH للخلايا LT4 التي تلعب دورا محوريا في الاستجابة المناعية النوعية المكتسبة، فتصبح إصابتها وتخريبها يؤدي إلى نقص إفراز الأنترلوكين 2 ينجم عنه العجز المناعي.",
              rule: {
                prompt: "اكتب نصا علميا حول سبب العجز المناعي",
                keywords: ["خلايا", "لمفاوية", "أنترلوكين", "CMH"],
                minHits: 3,
                forbidden: []
              }
            }
          ...
          poles: {
            ...
            S: {
              ...
              rule: {
                ...
                keywords: ["معقد", "مستضد", "تعطيل", "حماية"],
                minHits: 2,
                forbidden: []
              }
            },
            E: {
              ...
              rule: {
                ...
                keywords: ["ثانوية", "سريعة", "كمية", "أجسام"],
                minHits: 2,
                forbidden: []
              }
            },
        ...
        },
        {
          ...
          poles: {
            N: {
              ...
              minLength: 80,
              modelAnswer:
                "البيانات المرقمة: 1 منطقة انعطاف، 2 بنية حلزونية α، 3 بنية وريقية β. مستوى بنية البروتين: بنية ثالثية. التعليل: وجود سلسلة ببتيدية واحدة بها مجموعة من البنيات الثانوية α و β بالإضافة إلى وجود مناطق انعطاف. تمثيل الصيغة الكيميائية للجزء المؤطر (س): سلسلة ببتيدية تضم السيستينين المرتبطين بجسر ثنائي الكبريت، مع الأسبارجين والليزين في الطرفين، وتمثل الروابط: الجسور ثنائية الكبريت، الروابط الهيدروجينية، الرابطة الشاردية (الملحية)، والرابطة الكارهة للماء.",
              rule: {
                prompt: "تعرّف على البيانات ومثّل الصيغة",
                keywords: ["حلزون", "وريقية", "ببتيدية", "كبريت"],
                minHits: 3,
                forbidden: []
              }
            },
            S: {
              ...
              rule: {
                ...
                keywords: ["رامزة", "ARNm", "جدول", "مورثة"],
                minHits: 3,
                forbidden: []
              }
            },
            E: {
              ...
              rule: {
                ...
                keywords: ["طفرة", "رامزة", "بنية", "استبدال"],
                minHits: 3,
                forbidden: []
              }
            },
            W: {
              ...
              rule: {
                ...
                keywords: ["مورثة", "ARNm", "بنية", "وظيفة"],
                minHits: 3,
                forbidden: []
              }
            }
