/* ============================================================
   BAC SVT Algérie 2019 — شعبة رياضيات — ARMATURE « COPIE LIBRE »
   ------------------------------------------------------------
   ...
   le même que `npm run pdftext:status`) :
     ...
     sujet 1 — couche texte : transposé (3 192 car.)
     sujet 2 — couche texte : transposé (3 639 car.)
...
const ANNALS_PAGE = "https://www.dzexams.com/ar/annales/b2w2cDdSYTdOK05FMjNEMnNGeUlsdz09";
const PDF_SOURCE = "https://www.dzexams.com/uploads/sujets/officiels/bac/2019/dzexams-bac-sciences-2280992.pdf";

const PDF_NOTE =
  "PDF officiel servi par l'application : /subjects/M/2019/sujet-N.pdf. " +
  "Page annales de la source : https://www.dzexams.com/ar/annales/b2w2cDdSYTdOK05FMjNEMnNGeUlsdz09. " +
