/* ============================================================
   BAC SVT Algérie 2017 — شعبة رياضيات — ARMATURE « COPIE LIBRE »
   ------------------------------------------------------------
   ...
   le même que `npm run pdftext:status`) :
     ...
     sujet 1 — couche texte : transposé (2 791 car.)
     sujet 2 — couche texte : transposé (3 300 car.)
...
const ANNALS_PAGE = "https://www.dzexams.com/ar/annales/bEdWa2IycjEzcUY1S3FmUnpxdzhrQT09";
const PDF_SOURCE = "https://www.dzexams.com/uploads/sujets/officiels/bac/2017/dzexams-bac-sciences-2275712.pdf";

const PDF_NOTE =
  "PDF officiel servi par l'application : /subjects/M/2017/sujet-N.pdf. " +
  "Page annales de la source : https://www.dzexams.com/ar/annales/bEdWa2IycjEzcUY1S3FmUnpxdzhrQT09. " +
