        ...
        },
        {
          ...
          poles: {
            ...
            E: {
              ...
              minLength: 110,
              modelAnswer:
                "من الشكل (أ): عدد جزيئات البيرفورين في الخلية LTc أعظمي عند الطفل السليم (حوالي 3500 جزيئة) وقليل جدا عند الطفل المريض (حوالي 250 جزيئة): خلايا LTc عند المريض غير قادرة على تركيب البيرفورين بكميات طبيعية. من الشكلين (ب) و(ج): بمقارنة تتابع جزء مورثة PRF1 نلاحظ تماثل الثلاثيات 47 و49 و50 واختلافا في الثلاثية 48 حيث استُبدلت القاعدة الأزوتية G بالقاعدة A (GTC ← ATC) فصار الـ ARNm عند المريض UCA UAG UAU CAC بدل UCA CAG UAU CAC عند الطفل السليم: ظهرت رامزة التوقف UAG فيتوقف تركيب السلسلة الببتيدية عند الحمض الأميني Ser ويُركَّب بيرفورين غير مكتمل البنية. وهذا يؤكد صحة الفرضية 1: خلل في إنتاج البيرفورين عند الطفل المريض (كمية قليلة جدا وبنية غير مكتملة).",
              rule: {
