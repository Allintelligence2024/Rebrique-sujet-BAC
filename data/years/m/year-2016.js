/* ============================================================
   BAC SVT Algérie 2016 — شعبة رياضيات — ARMATURE « COPIE LIBRE »
   ------------------------------------------------------------
   ...
   le même que `npm run pdftext:status`) :
     ...
     sujet 1 — couche texte : transposé (2 696 car.)
     sujet 2 — couche texte : indéterminé (2 725 car.)
...
const ANNALS_PAGE = "https://www.dzexams.com/ar/annales/TW9GY3FMeVdkeFBBNGIwMmppdi9xQT09";

const PDF_NOTE =
  "PDF officiel servi par l'application : /subjects/M/2016/sujet-N.pdf. " +
  "Page annales de la source : https://www.dzexams.com/ar/annales/TW9GY3FMeVdkeFBBNGIwMmppdi9xQT09. " +
  "Couche texte : transposé / indéterminé — chiffres corrompus : aucun barème ni consigne n'a été recopié. " +
