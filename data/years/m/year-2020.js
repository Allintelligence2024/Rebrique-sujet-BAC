/* ============================================================
   BAC SVT Algérie 2020 — شعبة رياضيات — ARMATURE « COPIE LIBRE »
   ------------------------------------------------------------
   ...
   le même que `npm run pdftext:status`) :
     ...
     sujet 1 — couche texte : propre (3 910 car.)
     sujet 2 — couche texte : propre (2 299 car.)
...
const ANNALS_PAGE = "https://www.dzexams.com/ar/annales/dlFvUnNHKzlTdm5xZHJHMm4vL2hYZz09";

const PDF_NOTE =
  "PDF officiel servi par l'application : /subjects/M/2020/sujet-N.pdf. " +
  "Page annales de la source : https://www.dzexams.com/ar/annales/dlFvUnNHKzlTdm5xZHJHMm4vL2hYZz09. " +
  "Couche texte : propre / propre — chiffres corrompus : aucun barème ni consigne n'a été recopié. " +
