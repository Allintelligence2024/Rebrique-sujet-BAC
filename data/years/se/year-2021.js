/* ============================================================
   ...
   Deux questions avaient dérivé lors de cette recopie (elles vivent sur
   les deux pages alors non relues) : sujet 1 exercice 3 (« الممثلة في
   البروتوكول التجريبي للوثيقة (2) ») et sujet 2 exercice 3 (« مقر ودور
   … الرسالة العصبية للإحساس بالألم »). Les dix pages ont été relues sur
   image le 2026-09-16 et les deux passages recalés mot à mot ;
   `tests/se-2021-recopy.test.mjs` fixe le résultat, page source à l'appui.
      ...
      exercises: [
        ...
        skeleton(
          ...
          [
            ...
            "الجزء الثاني:",
            "1 ــ حدِّد هدف كل من التجارب ①②③ الممثلة في البروتوكول التجريبي للوثيقة (2).",
