      ...
      exercises: [
        {
          ...
          poles: {
            ...
            S: {
              ...
              minLength: 30,
              modelAnswer:
                "التسجيل (أ) جهد بعد مشبكي تنبيهي PPSE والتسجيل (ب) جهد بعد مشبكي تثبيطي PPSI. البروتين الغشائي المسؤول: مستقبل غشائي للمبلغ العصبي (مستقبل الأسيتيل كولين المنبّه ومستقبل GABA المثبط).",
              rule: {
        ...
        },
        {
          ...
          max: 7,
          desc: "تثبيط تركيب البروتين لدى طفيلي البلازموديوم المسبب للملاريا بدواء ML901، دون التأثير على خلايا الإنسان",
          poles: {
            N: {
              points: 1,
              ...
              minLength: 30,
              modelAnswer:
                "المشكل العلمي: كيف يثبط دواء ML901 تركيب البروتين لدى طفيلي البلازموديوم دون التأثير على خلايا الإنسان؟",
              rule: {
            ...
            E: {
              ...
              rule: {
                ...
                keywords: ["ML901", "تيروزين", "ARNt", "تنشيط", "ترجمة"],
                minHits: 3,
                forbidden: []
              }
            },
          ...
          poles: {
            N: {
              ...
              rule: {
                ...
                keywords: ["فرضية", "أستراديول", "تكاثر"],
                minHits: 1,
                forbidden: [],
                hypotheses: {
                  min: 2,
            ...
            S: {
              ...
              rule: {
                ...
                keywords: ["تكاثر", "أستراديول", "خلية", "اروماتاز"],
                minHits: 2,
                forbidden: ["بسبب"],
                document: {
                  kind: "curve",
            ...
            E: {
              ...
              rule: {
                ...
                keywords: ["اروماتاز", "كيرسيتين", "مستقبل", "أستراديول", "فرضية"],
                minHits: 3,
                forbidden: []
              }
            },
            W: {
              ...
              rule: {
                ...
                schema: {
                  arrows: true,
                  title: "تطور الورم",
                  ordered: ["أستراديول", "تكاثر", "كيرسيتين"]
                }
              }
            }
          }
          ...
          poles: {
            N: {
              ...
              rule: {
                ...
                keywords: ["نوكليوتيد", "بروتين", "طفرة", "بنية"],
                minHits: 2,
                forbidden: []
              }
            },
            S: {
              ...
              minLength: 30,
              modelAnswer:
                "أ- جسور ثنائية الكبريت فقط. ب- الروابط التي تنشأ بين أحماض أمينية محددة وموضعة بشكل دقيق في السلسلة الببتيدية. ت- ترتيب الترميزات في ARNm. ث- تغير على مستوى ADN.",
              rule: {
                prompt: "اختر العبارة الصحيحة حول بنية البروتين",
                keywords: ["كبريت", "ARNm", "ADN", "أمينية"],
                minHits: 2,
                forbidden: []
              }
            },
          ...
          poles: {
            N: {
              ...
              rule: {
                ...
                keywords: ["لمفاوية", "بيرفورين", "مصابة", "خلية"],
                minHits: 2,
                forbidden: []
              }
            },
            S: {
              ...
              rule: {
                ...
                keywords: ["غشاء", "كوليسترول", "بيرفورين", "لمفاوية"],
                minHits: 2,
                forbidden: ["بسبب"],
                document: {
                  kind: "curve",
                  axes: ["بنية", "غشاء"],
                  comparisons: [["LTc", "مصابة"]],
                  trends: [
                    {
                      about: "LTc",
                      expect: ["كوليسترول", "أعلى"]
                    }
                  ],
                  relations: [
                    {
            ...
            E: {
              ...
              minLength: 110,
              modelAnswer:
                "تعود حماية الخلايا LTc لنفسها إلى ارتفاع نسبة الكوليسترول والفينغومييلين (SM) في غشائها مما يخفض سيولته الغشائية، فيتعذر تثبيت البيرفورين وتشكل القنوات، فلا تتسرب أنزيمات الغرانزيم إلى داخل LTc؛ عكس غشاء الخلية المصابة الأفقر في الكوليسترول الذي يسمح بتثبيت البيرفورين وتشكل القنوات فتُخرَّب الخلية.",
              rule: {
                prompt: "اشرح آلية حماية LTc من البيرفورين",
                keywords: ["غشاء", "بيرفورين", "كوليسترول", "حماية", "تثبيت"],
                minHits: 3,
                forbidden: []
              }
            },
            W: {
              ...
              rule: {
                ...
                keywords: ["حماية", "لمفاوية", "بيرفورين"],
                minHits: 2,
                forbidden: []
              }
            }
          ...
          poles: {
            ...
            S: {
              ...
              rule: {
                ...
                keywords: ["أكسجين", "DCPIP", "ضوء", "ظلام"],
                minHits: 2,
                forbidden: ["بسبب"],
                document: {
                  kind: "curve",
            ...
            E: {
              ...
              rule: {
                ...
                keywords: ["DCMU", "PSII", "الكترون", "ناقل", "أكسدة"],
                minHits: 3,
                forbidden: []
              }
            },
