          ...
          poles: {
            ...
            S: {
              ...
              rule: {
                ...
                keywords: ["ببتيدية", "هيدروجينية", "كبريت", "أمينية"],
                minHits: 3,
                forbidden: []
              }
            },
            E: {
              ...
              rule: {
                ...
                keywords: ["ألبومين", "كبريت", "هيدروكسيل", "وذمة"],
                minHits: 3,
                forbidden: []
              }
            },
          ...
          poles: {
            ...
            S: {
              ...
              rule: {
                ...
                keywords: ["P53A", "NAD", "ركيزة", "انخفاض"],
                minHits: 3,
                forbidden: ["بسبب"],
                document: {
                  kind: "curve",
                  ...
                  relations: [{ type: "inverse", a: "NAD", b: "ركيزة" }],
                  values: ["7.55"],
                  strictValues: true
                }
              }
            ...
            E: {
              ...
              rule: {
                ...
                keywords: ["SIRT1", "أسيتيل", "P53", "ADN"],
                minHits: 3,
                forbidden: [],
                causalOrder: ["SIRT1", "أسيتيل"]
              }
            },
            W: {
              points: 1,
          ...
          poles: {
            ...
            S: {
              ...
              rule: {
                ...
                keywords: ["CO2", "فلورة", "أترازين", "امتصاص"],
                minHits: 3,
                forbidden: ["بسبب"],
                document: {
                  kind: "curve",
                  ...
                  trends: [
                    ...
                    { about: "معامل", expect: ["ينخفض", "فلورة"] }
                  ],
                  relations: [{ type: "inverse", a: "امتصاص", b: "فلورة" }],
                  values: ["25"],
                  strictValues: true
                }
              }
            ...
            W: {
              ...
              rule: {
                prompt: "أنجز مخططا وظيفيا لتأثير الأترازين",
                keywords: ["مخطط", "أترازين", "PSII"],
                minHits: 1,
                forbidden: [],
                schema: { arrows: true, title: "أترازين", ordered: ["أترازين", "PSII", "نقل"] }
              }
            }
          }
        }
              ...
              rule: {
                ...
                document: {
                  ...
                  trends: [
                    ...
                    { about: "KO", expect: ["ثبات", "حيوية"] }
                  ],
                  relations: [{ type: "inverse", a: "Ca", b: "حيوية" }],
                  values: ["31"],
                  strictValues: true
                }
              }
          ...
          poles: {
            ...
            W: {
              ...
              rule: {
                ...
                keywords: ["مخطط", "TfR", "بلعمة"],
                minHits: 1,
                forbidden: [],
                schema: { arrows: true, title: "زهايمر", ordered: ["Anti", "TfR", "بلعمة"] }
              }
            }
          }
        }
