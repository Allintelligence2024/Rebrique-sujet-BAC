          ...
          poles: {
            N: {
              ...
              rule: {
                ...
                keywords: ["فرضية", "ترجمة", "جينتاميسين"],
                minHits: 2,
                forbidden: []
              }
            },
        ...
        },
        {
          ...
          poles: {
            ...
            E: {
              ...
              minLength: 110,
              modelAnswer:
                "الشكل (أ): في غياب 3-NOP يترفع إنتاج الميثان من 130 غ/اليوم إلى 330 غ/اليوم ثم يثبت، بينما في وجود 3-NOP يتناقص إنتاج الميثان من 330 غ/اليوم إلى 230 غ/اليوم ثم يثبت: يقلل المكمل الغذائي 3-NOP من غاز الميثان. الشكل (ب): في وجود CO₂ وبإضافة الهيدروجين ينتج أنزيم M (مرافقه CoEM) غاز الميثان والماء: يستخدم أنزيم M مرافقه CoEM التي يربطها لتحويل CO₂ إلى غاز الميثان. الشكل (ج): يتنافس المكمل الغذائي 3-NOP مع المرافق الأنزيمي CoEM على تثبيت الموقع الخاص للرفاق الأنزيمي على أنزيم M؛ في غياب CoEM يكون الأنزيم غير وظيفي، وفي وجود CoEM يثبت على جزء من الأنزيم حيث تتشكل روابط بين الحمض الأميني Arg120 وTyr333 ما يجعله وظيفيا؛ وفي وجود CoEM و3-NOP يأخذ 3-NOP مكان CoEM فتتوقف التفاعلات فيصبح الأنزيم غير وظيفي. (يعمل 3-NOP على منع ارتباط CoEM ما يوقف نشاط أنزيم M، فينخفض إنتاج وانبعاث غاز الميثان مع الحفاظ على التفاعلات الأيضية الهضمية للأبقار : تتأكد الفرضية المقترحة.)",
              rule: {
