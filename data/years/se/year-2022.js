          ...
          poles: {
            ...
            S: {
              ...
              rule: {
                ...
                keywords: ["فسفوليب", "بروتين", "طبقتين", "كارهة"],
                minHits: 3,
                forbidden: []
              }
            },
          ...
          poles: {
            N: {
              ...
              rule: {
                ...
                keywords: ["فرضية", "ترجمة", ["جينتامسين", "جينتاميسين"]],
                minHits: 2,
                forbidden: []
              }
            },
            ...
            E: {
              ...
              rule: {
                ...
                keywords: ["ترجمة", "رامزة", "بروتين", "فرضية"],
                minHits: 3,
                forbidden: [],
    ...
    },
    {
      ...
      exercises: [
          ...
          poles: {
            ...
            E: {
              ...
              rule: {
                ...
                keywords: ["atp", "مضخة", "تسرب", "قنوات", "سيانور"],
                minHits: 3,
                forbidden: [],
          ...
          poles: {
            N: {
              ...
              rule: {
                ...
                keywords: ["amanitine", "بروتين", "سرطانية"],
                minHits: 2,
                forbidden: []
              }
            },
            S: {
              ...
              rule: {
                ...
                keywords: ["بوليميراز", "نشاط", "الحلقة", "نسخ", "تركيز"],
                minHits: 3,
                forbidden: ["بسبب"]
              }
            },
            E: {
              ...
              rule: {
                ...
                keywords: ["amanitine", "جسم", "سرطانية", "نسخ", "ورم"],
                minHits: 3,
                forbidden: [],
        ...
        },
        {
          ...
          max: 8,
          desc: "إنتاج غاز الميثان (CH₄) أثناء الاجتراء بتدخل أنزيم M (المرافق CoEM)، وتأثير المكمل الغذائي (3-NOP) التنافسي على الموقع الخاص للمرافق الأنزيمي",
          poles: {
            N: {
              points: 0.5,
            ...
            E: {
              ...
              minLength: 110,
              modelAnswer:
                "الشكل (أ): في غياب 3-NOP يترفع إنتاج الميثان من 130 غ/اليوم إلى 330 غ/اليوم ثم يثبت، بينما في وجود 3-NOP يتناقص إنتاج الميثان من 330 غ/اليوم إلى 230 غ/اليوم ثم يثبت: يقلل المكمل الغذائي 3-NOP من غاز الميثان. الشكل (ب): في وجود CO₂ وبإضافة الهيدروجين ينتج أنزيم M (مرافقه CoEM) غاز الميثان والماء: يستخدم أنزيم M مرافقه CoEM التي يربطها لتحويل CO₂ إلى غاز الميثان. الشكل (ج): يتنافس المكمل الغذائي 3-NOP مع المرافق الأنزيمي CoEM على تثبيت الموقع الخاص المرافق الأنزيمي على أنزيم M؛ في غياب CoEM يكون الأنزيم غير وظيفي، وفي وجود CoEM يثبت على جزء من الأنزيم حيث تتشكل روابط بين الحمض الأميني Arg120 وTyr333 ما يجعله وظيفيا؛ وفي وجود CoEM و3-NOP يأخذ 3-NOP مكان CoEM فتتوقف التفاعلات فيصبح الأنزيم غير وظيفي. (يعمل 3-NOP على منع ارتباط CoEM ما يوقف نشاط أنزيم M، فينخفض إنتاج وانبعاث غاز الميثان مع الحفاظ على التفاعلات الأيضية الهضمية للأبقار : تتأكد الفرضية المقترحة.)",
              rule: {
                prompt: "وضّح تأثير 3-NOP مع المصادقة",
                keywords: ["nop", "coem", "ميثان", "ارتباط"],
                minHits: 3,
                forbidden: [],
