      ...
      sujets: [
        {
          ...
          pdf: null,
          pdfAvailable: false,
          pdfExternalUrl: "https://www.dzexams.com/uploads/sujets/officiels/bac/2020/dzexams-bac-sciences-2356016.pdf",
          pdfNote: "PDF non redistribué dans le dépôt. Page dzexams : https://www.dzexams.com/ar/annales/SUFqL0VzRjNzdmd6ek1EekpsOTFMdz09. Sujet 1 : thèmes relus sur la couche texte dzexams (OCR bruité, 2026-08-30). Sujet 2 : couche texte incomplète ; thèmes pédagogiques du programme, non certifiables.",
          title: "الموضوع الأول",
          exercises: [
          {
            number: 1,
        ...
        N: {
          ...
          ...RECON("Couche texte dzexams bruitée ou inversée, relue le 2026-08-30. Wording reconstructed, non certifiable official. Pas de question autonome de cadrage pour N/W quand la consigne officielle est unique."),
          placeholder: "صياغة المشكل العلمي...",
          minLength: 40,
          modelAnswer: "المشكل العلمي: كيف تسمح المعطيات الزلزالية بمعرفة البنية الداخلية للكرة الأرضية وحالة الأوساط والصخور المميزة رغم استحالة الوصول المباشر؟",
          rule: {
            prompt: "تأطير الإشكالية: كيف كشفت المعطيات الزلزالية البنية الداخلية للكرة الأرضية؟",
        ...
        S: {
          ...
          minLength: 40,
          modelAnswer: "نحدد الحالة الفيزيائية للأوساط: القشرة صلبة، الرداء العلوي لدن في جزء منه، النواة الخارجية سائلة. الصخور الاندساسية المميزة: غرانيت في القشرة القارية وبازلت في القشرة المحيطية. الانقطاعات: موهو بين القشرة والرداء، وغوتنبرغ بين الرداء والنواة.",
          rule: {
            prompt: "ملء الجدول: الحالة الفيزيائية والصخر الاندساسي واسم الانقطاع",
        ...
        E: {
          ...
          bacPrompt: "بيّن في نص علمي كيف تم استغلال المعطيات الزلزالية لمعرفة البنية الداخلية للكرة الأرضية اعتمادا على معلوماتك.",
          ...RECON("Couche texte dzexams bruitée ou inversée, relue le 2026-08-30. Wording reconstructed, non certifiable official. Pas de question autonome de cadrage pour N/W quand la consigne officielle est unique."),
          placeholder: "مقدمة، عرض، خاتمة...",
          minLength: 120,
          modelAnswer: "تنتشر الموجات الزلزالية بسرعات مختلفة حسب طبيعة الأوساط. يتغير مسارها عند الانقطاعات فيظهر انعكاس وانكسار، ويختفي بعض الموجات في منطقة الظل، مما يدل على وسط سائل في النواة الخارجية. ومن تغير السرعة والحالة الفيزيائية والصخور المميزة تُبنى صورة طبقية للكرة الأرضية.",
          rule: {
            prompt: "نص علمي: كيف كشفت المعطيات الزلزالية البنية الداخلية",
        ...
        W: {
          ...
          minLength: 40,
          modelAnswer: "في الختام، يتعذر الحفر المباشر إلى الأعماق، فتبقى الموجات الزلزالية الوسيلة الأساسية لكشف تتابع الأوساط والانقطاعات داخل الكرة الأرضية.",
          rule: {
            prompt: "الخاتمة: حدود الاستغلال المباشر وضرورة الزلازل",
        ...
        N: {
          ...
          placeholder: "صياغة المشكل العلمي...",
          minLength: 40,
          modelAnswer: "المشكل العلمي: كيف يرتبط إيبوبروفان وأنزيما Cox-1 وCox-2 بالموقع الفعال، وكيف يقلل سلكوكزيب الأعراض الجانبية؟",
          rule: {
            prompt: "تأطير الإشكالية: كيف يُستغل الموقع الفعال لإنتاج دواء أقل أعراضا جانبية؟",
        ...
        S: {
          ...
          minLength: 90,
          modelAnswer: "تمثل الوثيقة مخطط نشاط أنزيمي Cox-1 وCox-2 وتركيز إيبوبروفان اللازم لخفض النشاط إلى النصف. نلاحظ أن إيبوبروفان يخفض نشاط الأنزيمين معا، وأن تركيزه اللازم لـ Cox-1 أقل مما هو لـ Cox-2، ومنه نستنتج تثبيطا غير انتقائي يفسر الأعراض الجانبية.",
          rule: {
            prompt: "تحليل مخطط نشاط Cox-1 وCox-2 وجدول IC50 لإيبوبروفان",
            keywords: ["cox","ايبوبروفان","نشاط","تركيز"],
            minHits: 2,
            forbidden: ["بسبب"],
          document: {"kind":"table","axes":["نشاط","تركيز"],"comparisons":[["Cox-1","Cox-2"]],"cells":[["ايبوبروفان","نشاط"]],"values":[],"strictValues":false}
          }
        },
        E: {
          points: 2.5,
          prompt: "تفسير تأثير إيبوبروفان وسلكوكزيب على الموقع الفعال",
          bacPrompt: "علل تأثير الأنزيمين على نفس الركيزة وتأثير إيبوبروفان عليهما، ثم فسّر منحنى نشاط سلكوكزيب.",
          ...RECON("Couche texte dzexams bruitée ou inversée, relue le 2026-08-30. Wording reconstructed, non certifiable official. Pas de question autonome de cadrage pour N/W quand la consigne officielle est unique."),
          placeholder: "حمض أراشيدونيك، موقع فعال، سلكوكزيب...",
          minLength: 110,
          modelAnswer: "يعود تأثير الأنزيمين على حمض الأراشيدونيك إلى تشابه جزء من الموقع الفعال. يثبت إيبوبروفان على الموقعين فيثبط Cox-1 وCox-2 معا. أما سلكوكزيب فيرتبط تفضيليا بـ Cox-2 فينخفض نشاطه بينما يبقى Cox-1 تقريبا وظيفيا، فتقل الأعراض الجانبية.",
          rule: {
            prompt: "تفسير تأثير إيبوبروفان وسلكوكزيب على الموقع الفعال",
        ...
        W: {
          ...
          placeholder: "في الختام...",
          minLength: 40,
          modelAnswer: "في الختام، يُختار دواء انتقائي اتجاه Cox-2 مثل سلكوكزيب حتى يُحفظ نشاط Cox-1 المسؤول عن حماية الغشاء المخاطي فتخف الأعراض الجانبية.",
          rule: {
            prompt: "اقتراح حل لتخفيف الأعراض الجانبية",
        ...
        N: {
          ...
          placeholder: "الفرضية...",
          minLength: 30,
          modelAnswer: "الفرضية: ترتبط أجسام مضادة نوعية بالبروتين الغشائي Her2 على الخلايا السرطانية فتوقف تكاثرها وتسهّل تخريبها.",
          rule: {
            prompt: "اقتراح فرضية حول آلية القضاء على خلايا سرطان الثدي",
        ...
        S: {
          ...
          bacPrompt: "استغل الشكل أ من الوثيقة: كمية البروتين الغشائي Her2 عند خليتين سرطانيتين وعدد الخلايا بعد سبعة أيام من الحضن.",
          ...RECON("Couche texte dzexams bruitée ou inversée, relue le 2026-08-30. Wording reconstructed, non certifiable official. Pas de question autonome de cadrage pour N/W quand la consigne officielle est unique."),
          placeholder: "قارن الخلايا A وB...",
          minLength: 60,
          modelAnswer: "تمثل الوثيقة كمية البروتين Her2 وعدد الخلايا السرطانية بعد الحضن. نلاحظ عند الخلايا A المأخوذة من ثدي مصاب كمية Her2 أعلى وعددا أكبر بعد سبعة أيام مقارنة بالخلايا B، ومنه نستنتج ارتباط التكاثر بارتفاع Her2.",
          rule: {
            prompt: "استغلال كمية Her2 وعدد الخلايا السرطانية بعد الحضن",
            keywords: ["her2","خلايا","سرطانيه","كميه"],
            minHits: 2,
            forbidden: ["بسبب"],
          document: {"kind":"table","axes":["كميه","عدد"],"comparisons":[["A","B"]],"cells":[["her2","خلايا"]],"values":[],"strictValues":false}
          }
        },
        E: {
          points: 4,
          ...
          minLength: 110,
          modelAnswer: "يعود ذلك إلى تثبيت الجسم المضاد النوعي على Her2 فيُحجب مستقبل النمو ويتوقف التكاثر، كما يُعلَّم الغشاء فتتدخل خلايا مناعية تخرب الخلية السرطانية. العلاج المناعي يستغل هذه النوعية.",
          rule: {
            prompt: "تفسير آلية العلاج المناعي ضد Her2",
        ...
        W: {
          ...
          minLength: 40,
          modelAnswer: "عنوان المخطط: علاج مناعي ضد Her2. Her2 على الغشاء → جسم مضاد نوعي → حجب مستقبل النمو → توقف التكاثر → تخريب الخلية السرطانية.",
          rule: {
            prompt: "مخطط مسار العلاج المناعي",
        ...
        N: {
          ...
          ...RECON("Thème recoupé sur des sources secondaires et le programme 3AS, sans relecture visuelle d un PDF ministériel dans cette session. Wording reconstructed, non certifiable official. À confronter au PDF dzexams avant toute utilisation comme énoncé."),
          placeholder: "صياغة المشكل العلمي...",
          minLength: 40,
          modelAnswer: "المشكل العلمي: كيف يفرض تتابع نوكليوتيدات ARNm ترتيب الأحماض الأمينية أثناء الترجمة في الهيولى؟",
          rule: {
            prompt: "تأطير الإشكالية: كيف تُترجم معلومة ARNm إلى بروتين؟",
        ...
        E: {
          ...
          minLength: 120,
          modelAnswer: "ترتبط تحت الوحدة الصغرى بـ ARNm ثم يثبت ARNt الحامل للميثيونين على رامزة الانطلاق، فتستطيل السلسلة بروابط بيبتيدية وفق الرامزات حتى رامزة التوقف فينفصل متعدد الببتيد.",
          rule: {
            prompt: "نص علمي حول خطوات الترجمة",
        ...
        N: {
          ...
          placeholder: "صياغة المشكل العلمي...",
          minLength: 40,
          modelAnswer: "المشكل العلمي: كيف يحرَّر المبلغ العصبي في الشق المشبكي فيولّد جهدا بعد مشبكي على الغشاء التالي؟",
          rule: {
            prompt: "تأطير الإشكالية: كيف تنتقل الرسالة عبر المشبك الكيميائي؟",
        ...
        S: {
          ...
          minLength: 90,
          modelAnswer: "تمثل الوثيقة تسجيلات الكمون بدلالة الزمن قبل المشبك وبعده. نلاحظ كمون عمل في الغشاء قبل المشبكي وجهدا بعد مشبكي تنبيهيا على الغشاء التالي بعد تأخير مشبكي، ومنه نستنتج انتقالا كيميائيا عبر المبلغ.",
          rule: {
            prompt: "تحليل تسجيلات قبل وبعد المشبك",
            keywords: ["كمون","مشبكي","تسجيل"],
            minHits: 2,
            forbidden: ["بسبب"],
          document: {"kind":"curve","axes":["كمون","زمن"],"comparisons":[["قبل","بعد"]],"trends":[{"about":"بعد","expect":["كمون","مشبكي"]}],"values":[],"strictValues":false}
          }
        },
        E: {
          points: 2.5,
          ...
          minLength: 110,
          modelAnswer: "يدخل Ca²⁺ إلى النهاية قبل المشبكية فتهاجر الحويصلات ويتحرر المبلغ في الشق، فيثبت على مستقبل بعد مشبكي فتنفتح قنوات شاردية ويتولد جهد بعد مشبكي.",
          rule: {
            prompt: "شرح آلية تحرير المبلغ العصبي",
        ...
        S: {
          ...
          minLength: 60,
          modelAnswer: "تمثل الوثيقة استهلاك O2 وإنتاج ATP بدلالة الزمن. نلاحظ انخفاض O2 وارتفاع ATP بعد إضافة نواقل مرجعة، ومنه نستنتج اقتران أكسدة النواقل بفسفرة ADP.",
          rule: {
            prompt: "استغلال استهلاك O2 وإنتاج ATP",
            keywords: ["اكسجين","ATP","نواقل"],
            minHits: 2,
            forbidden: ["بسبب"],
          document: {"kind":"curve","axes":["ATP","زمن"],"comparisons":[["O2","ATP"]],"trends":[{"about":"ATP","expect":["ارتفاع","ATP"]}],"values":[],"strictValues":false}
          }
        },
        E: {
          points: 4,
          ...
          minLength: 110,
          modelAnswer: "تتأكسد النواقل فتنتقل الإلكترونات في السلسلة التنفسية نحو O2، وتُضخ البروتونات إلى الفراغ بين الغشاءين، ثم تعود عبر ATP سنتاز فيتشكل ATP.",
          rule: {
            prompt: "شرح السلسلة التنفسية وتشكل ATP",
        ...
        W: {
          ...
          minLength: 40,
          modelAnswer: "عنوان المخطط: فسفرة تأكسدية. نواقل مرجعة → سلسلة تنفسية → تدرج بروتونات → ATP سنتاز → ATP.",
          rule: {
            prompt: "مخطط تحويل الطاقة",
      ...
      sujets: [
        {
          ...
          pdf: null,
          pdfAvailable: false,
          pdfExternalUrl: "https://www.dzexams.com/uploads/sujets/officiels/bac/2019/dzexams-bac-sciences-3051478.pdf",
          pdfNote: "PDF non redistribué dans le dépôt. Page dzexams : https://www.dzexams.com/ar/annales/OHlmRldmdmdDVUNVRHBadTE5em0vdz09. PDF dzexams محمي بكلمة مرور في العارض. Thèmes reconstruits pédagogiquement, non certifiables.",
          title: "الموضوع الأول",
          exercises: [
          {
            number: 1,
        ...
        S: {
          ...
          placeholder: "بداية، استطالة، نهاية...",
          minLength: 40,
          modelAnswer: "البداية: يرتبط ARN بوليميراز ببداية المورثة ويفتح السلسلتين. الاستطالة: يقرأ السلسلة الناسخة ويربط نوكليوتيدات مكملة. النهاية: يصل إلى نهاية المورثة فينفصل ARNm.",
          rule: {
            prompt: "تعرف على مراحل الاستنساخ",
        ...
        E: {
          ...
          placeholder: "مقدمة، عرض، خاتمة...",
          minLength: 120,
          modelAnswer: "في النواة يرتبط ARN بوليميراز بالمورثة ويكسر الروابط الهيدروجينية، ثم يركب ARNm وفق تتابع السلسلة الناسخة حتى نهاية المورثة فينفصل الجزيء حاملا المعلومة إلى الهيولى.",
          rule: {
            prompt: "نص علمي حول الاستنساخ",
        ...
        N: {
          ...
          placeholder: "صياغة المشكل العلمي...",
          minLength: 40,
          modelAnswer: "المشكل العلمي: كيف يتكامل الموقع الفعال مع مادة التفاعل فيحدد التخصص، وكيف تؤثر الحرارة وpH؟",
          rule: {
            prompt: "تأطير الإشكالية: ما أصل التخصص الإنزيمي؟",
        ...
        S: {
          ...
          minLength: 90,
          modelAnswer: "نلاحظ سرعة أعظمية عند درجة pH وحرارة مثلى، بينما تنخفض السرعة في الطرفين، ومنه نستنتج وجود ظروف مثلى للنشاط الإنزيمي.",
          rule: {
            prompt: "تحليل تغيرات السرعة بدلالة pH والحرارة",
            keywords: ["سرعه","حراره","نشاط"],
            minHits: 2,
            forbidden: ["بسبب"],
          document: {"kind":"curve","axes":["سرعه","PH"],"comparisons":[["مثلى","طرف"]],"trends":[{"about":"مثلى","expect":["اعظميه","سرعه"]}],"values":[],"strictValues":false}
          }
        },
        E: {
          points: 2.5,
          ...
          minLength: 110,
          modelAnswer: "يغيّر pH شحنات الأحماض الأمينية في الموقع الفعال فيضعف التكامل مع الركيزة. وارتفاع الحرارة يخرب البنية الفراغية فيفقد الإنزيم تخصصه.",
          rule: {
            prompt: "تفسير تأثير pH والحرارة على الموقع الفعال",
        ...
        N: {
          ...
          minLength: 30,
          modelAnswer: "الفرضية 1: تستجيب LB بإنتاج أجسام مضادة نوعية. الفرضية 2: تستجيب LTc بتخريب الخلايا المصابة.",
          rule: {
            prompt: "اقتراح فرضيتين حول آلية القضاء على المستضد",
        ...
        S: {
          ...
          minLength: 60,
          modelAnswer: "تمثل الوثيقة كمية الأجسام المضادة وعدد LTc بدلالة الزمن. نلاحظ بعد الحقن طورا كمونيا ثم ارتفاع كمية الأجسام المضادة وعدد LTc، ومنه نستنتج استجابة نوعية خلطية وخلوية.",
          rule: {
            prompt: "استغلال نتائج حقن المستضد",
            keywords: ["اجسام","مضاده","LTc"],
            minHits: 2,
            forbidden: ["بسبب"],
          document: {"kind":"curve","axes":["كميه","زمن"],"comparisons":[["مضاده","LTc"]],"trends":[{"about":"مضاده","expect":["ارتفاع","كميه"]}],"values":[],"strictValues":false}
          }
        },
        E: {
          points: 4,
          ...
          minLength: 110,
          modelAnswer: "تتعرف LT4 على الببتيد المعروض مع CMH II فتفرز إنترلوكينات تحفّز تكاثر LB وتمايزها إلى بلاسموسيت وتكاثر LTc، فتتأكد الفرضيتان بالتعاون المناعي.",
          rule: {
            prompt: "تفسير التعاون المناعي",
        ...
        W: {
          ...
          minLength: 40,
          modelAnswer: "عنوان المخطط: استجابة نوعية. مستضد → عرض على CMH → LT4 → إنترلوكينات → أجسام مضادة وتخريب خلوي.",
          rule: {
            prompt: "مخطط الاستجابة النوعية",
        ...
        S: {
          ...
          minLength: 40,
          modelAnswer: "زوال الاستقطاب بدخول Na⁺ عبر قنوات فولطية، ثم عودة الاستقطاب بخروج K⁺، يليه فرط استقطاب عابر قبل العودة إلى كمون الراحة.",
          rule: {
            prompt: "تعرف على أطوار كمون العمل",
        ...
        E: {
          ...
          minLength: 120,
          modelAnswer: "عند بلوغ العتبة تنفتح قنوات Na⁺ الفولطية فيدخل الصوديوم ويزول الاستقطاب، ثم تنفتح قنوات K⁺ فيخرج البوتاسيوم وتعود القطبية، فينتشر كمون العمل على طول الليف.",
          rule: {
            prompt: "نص علمي حول آلية كمون العمل",
        ...
        S: {
          ...
          minLength: 90,
          modelAnswer: "تمثل الوثيقة تغيرات الأكسجين وATP بدلالة الزمن. نلاحظ انخفاض O2 وارتفاع CO2 وATP في وجود الغلوكوز، ومنه نستنتج أكسدة الغلوكوز المقترنة بإنتاج طاقة قابلة للاستعمال.",
          rule: {
            prompt: "تحليل استهلاك O2 وإنتاج CO2 وATP",
            keywords: ["اكسجين","ATP","غلوكوز"],
            minHits: 2,
            forbidden: ["بسبب"],
          document: {"kind":"curve","axes":["اكسجين","زمن"],"comparisons":[["O2","ATP"]],"trends":[{"about":"ATP","expect":["ارتفاع","ATP"]}],"values":[],"strictValues":false}
          }
        },
        E: {
          points: 2.5,
          ...
          minLength: 110,
          modelAnswer: "يتحلل الغلوكوز في الهيولى إلى حمض بيروفيك، ثم تتأكسد في المادة الأساسية للميتوكوندري داخل حلقة كريبس، وتُؤكسَد النواقل في السلسلة التنفسية فينتج ATP وماء.",
          rule: {
            prompt: "شرح مراحل التنفس",
        ...
        S: {
          ...
          minLength: 60,
          modelAnswer: "تمثل الوثيقة عمر البازلت وتدفق الحرارة بدلالة المسافة. نلاحظ عند الظهرة حرارة أعلى وعمرا أصغر، بينما عند الطرف يزداد العمر وتنخفض الحرارة، ومنه نستنتج توسعا محيطيا.",
          rule: {
            prompt: "استغلال أعمار البازلت وتدفق الحرارة",
            keywords: ["ظهره","بازلت","حراره"],
            minHits: 2,
            forbidden: ["بسبب"],
          document: {"kind":"table","axes":["عمر","مسافه"],"comparisons":[["ظهره","طرف"]],"cells":[["بازلت","حراره"]],"values":[],"strictValues":false}
          }
        },
        E: {
          points: 4,
          ...
          minLength: 110,
          modelAnswer: "تصعد مادة ساخنة قليلة الكثافة عند الظهرة فتتكون قشرة جديدة، وتهبط الصفيحة الباردة في مناطق الغوص، فتتأكد فرضية الحمل الحراري كمحرك.",
          rule: {
            prompt: "تفسير محرك الصفائح",
      ...
      sujets: [
        {
          ...
          pdfNote: "PDF non redistribué dans le dépôt. Page dzexams : https://www.dzexams.com/ar/annales/RGZmd0lTRW0xNmZTRUFjR0F5QzMwZz09. Thèmes relus sur la couche texte dzexams (OCR inversé, 2026-08-30). Wording reconstructed.",
          title: "الموضوع الأول",
          exercises: [
          {
            number: 1,
        ...
        N: {
          ...
          placeholder: "صياغة المشكل العلمي...",
          minLength: 40,
          modelAnswer: "المشكل العلمي: كيف تتدخل مختلف البروتينات الغشائية في توليد وانتشار الرسالة العصبية ودمجها على مستوى العصبون المحرك؟",
          rule: {
            prompt: "تأطير الإشكالية: كيف تؤمن البروتينات الغشائية نقل الرسالة العصبية ودمجها؟",
        ...
        S: {
          ...
          bacPrompt: "اذكر مختلف البروتينات الغشائية المتدخلة في توليد وانتشار الرسالة العصبية عبر سلسلة عصبونية محددا دور كل منها.",
          ...RECON("Couche texte dzexams bruitée ou inversée, relue le 2026-08-30. Wording reconstructed, non certifiable official. Pas de question autonome de cadrage pour N/W quand la consigne officielle est unique."),
          placeholder: "قنوات فولطية، مضخة، مستقبلات...",
          minLength: 40,
          modelAnswer: "القنوات الفولطية لـ Na⁺ وK⁺ تولد كمون العمل. مضخة Na⁺/K⁺ تحفظ كمون الراحة. قنوات الكالسيوم الفولطية تسمح بالتحرير. مستقبلات بعد مشبكية تولد PPSE أو PPSI.",
          rule: {
            prompt: "ذكر البروتينات الغشائية ودور كل منها",
        ...
        E: {
          ...
          minLength: 120,
          modelAnswer: "تصل إلى العصبون المحرك جهود بعد مشبكية تنبيهية وتثبيطية. يُدمج المحصّل تجميعا فضائيا وزمانيا على مستوى القطعة الابتدائية، فإذا بلغ العتبة تولد كمون عمل وانتشر نحو العضلة.",
          rule: {
            prompt: "نص علمي حول دمج الرسائل على العصبون المحرك",
        ...
        N: {
          ...
          placeholder: "صياغة المشكل العلمي...",
          minLength: 40,
          modelAnswer: "المشكل العلمي: كيف تضمن أحماض أمينية محددة ثبات مستقبل LDL، وكيف تفقد الطفرة هذا التخصص فيرتفع الكولسترول؟",
          rule: {
            prompt: "تأطير الإشكالية: كيف تؤدي طفرة مستقبل LDL إلى تصلب الشرايين؟",
        ...
        S: {
          ...
          bacPrompt: "حدد بدقة دور الأحماض الأمينية في كشف وثبات البنية الفراغية للمستقبل R باستغلال الشكلين أ و ب.",
          ...RECON("Couche texte dzexams bruitée ou inversée, relue le 2026-08-30. Wording reconstructed, non certifiable official. Pas de question autonome de cadrage pour N/W quand la consigne officielle est unique."),
          placeholder: "جسور، شحنات، تموضع...",
          minLength: 90,
          modelAnswer: "تمثل الوثيقة تتابع الأحماض الأمينية في المستقبل LDL بدلالة الموضع عند السليم والمصاب. نلاحظ تموضعا دقيقا لأحماض مشحونة وكبريتية عند السليم، بينما يختل التموضع عند المصاب، ومنه نستنتج أن الروابط تثبّت البنية الفراغية اللازمة للتعرف على LDL.",
          rule: {
            prompt: "تحديد دور الأحماض الأمينية في ثبات المستقبل",
            keywords: ["احماض","بنيه","مستقبل","LDL"],
            minHits: 2,
            forbidden: ["بسبب"],
          document: {"kind":"table","axes":["حمض","موضع"],"comparisons":[["سليم","مصاب"]],"cells":[["LDL","مستقبل"]],"values":[],"strictValues":false}
          }
        },
        E: {
          points: 2.5,
          prompt: "مناقشة العلاقة بين الطفرة وتصلب الشرايين",
          bacPrompt: "ناقش العلاقة بين بنية المستقبل الغشائي لـ LDL والحالة الصحية للشخص السليم مقارنة بالمصاب.",
          ...RECON("Couche texte dzexams bruitée ou inversée, relue le 2026-08-30. Wording reconstructed, non certifiable official. Pas de question autonome de cadrage pour N/W quand la consigne officielle est unique."),
          placeholder: "أليل R1 وR2، كولسترول...",
          minLength: 110,
          modelAnswer: "عند السليم يثبت LDL على مستقبل وظيفي فيُقتنص. عند المصاب تغيّر الطفرة حمضا أمينيا فيفقد المستقبل شكله فلا يدخل LDL، فيرتفع الكولسترول في الدم ويتصلب الشريان.",
          rule: {
            prompt: "مناقشة العلاقة بين الطفرة وتصلب الشرايين",
        ...
        N: {
          ...
          placeholder: "الفرضية...",
          minLength: 30,
          modelAnswer: "الفرضية: يعود نقص الحركة إلى خلل في أكسدة النواقل المرجعة فلا يتشكل ATP الكافي لحركة النطفة.",
          rule: {
            prompt: "اقتراح فرضية حول سبب قلة حركة النطاف",
        ...
        S: {
          ...
          minLength: 60,
          modelAnswer: "تمثل الوثيقة نسبة الأكسجين بدلالة الزمن في المعلق السليم والمصاب. نلاحظ عند السليم انخفاضا واضحا في O2 بعد إضافة TH2، بينما يبقى الانخفاض ضعيفا عند المصاب، ومنه نستنتج ضعفا في أكسدة النواقل عند المصاب.",
          rule: {
            prompt: "تحليل استهلاك O2 في معلق النطاف",
            keywords: ["اكسجين","نطاف","ناقل"],
            minHits: 2,
            forbidden: ["بسبب"],
          document: {"kind":"curve","axes":["اكسجين","زمن"],"comparisons":[["سليم","مصاب"]],"trends":[{"about":"سليم","expect":["انخفاض","اكسجين"]}],"values":[],"strictValues":false}
          }
        },
        E: {
          points: 4,
          ...
          minLength: 110,
          modelAnswer: "يعيد Coenzyme Q10 نقل الإلكترونات في السلسلة التنفسية فيستأنف تدرج البروتونات ويتشكل ATP فتعود حركة النطاف، فتتأكد فرضية الخلل الطاقوي.",
          rule: {
            prompt: "تفسير تأثير Coenzyme Q10",
        ...
        W: {
          ...
          minLength: 40,
          modelAnswer: "عنوان المخطط: طاقة النطفة. فركتوز → نواقل مرجعة → سلسلة تنفسية تستهلك O2 → ATP → نطاف. في وجود Q10 تُستأنف السلسلة.",
          rule: {
            prompt: "مخطط العلاقة أيض-O2-وظائف حيوية",
        ...
        N: {
          ...
          placeholder: "صياغة المشكل العلمي...",
          minLength: 40,
          modelAnswer: "المشكل العلمي: كيف تحدد الأليلات IA وIB وi نوع المستضد الغشائي على كرية الدم الحمراء؟",
          rule: {
            prompt: "تأطير الإشكالية: كيف يظهر النمط الظاهري للزمرة؟",
        ...
        S: {
          ...
          minLength: 40,
          modelAnswer: "الزمرة O تحمل مستضد H فقط، والزمرة A تضيف غالاكتوز أمين على H، والزمرة B تضيف غالاكتوز، والزمرة AB تحمل المستضدين A وB.",
          rule: {
            prompt: "المقارنة بين الزمر والمؤشرات",
        ...
        E: {
          ...
          minLength: 120,
          modelAnswer: "يشرف الصبغي 9 على أليلات IA وIB السائدتين بالنسبة إلى i المتنحي، وبين IA وIB غياب سيادة. يركّب كل أليل سائد إنزيما يضيف سكرا نوعيا على المستضد H فيظهر النمط الظاهري للزمرة.",
          rule: {
            prompt: "نص علمي حول وراثة الزمر",
        ...
        S: {
          ...
          minLength: 90,
          modelAnswer: "تمثل الوثيقة تغير السرعة بدلالة pH. نلاحظ سرعة أعظمية عند pH قريب من المعتدل وحرارة متوسطة، بينما تنعدم عند الطرف، ومنه نستنتج أن اللاكتاز يعمل في ظروف المعي الدقيق.",
          rule: {
            prompt: "تحليل أثر pH والحرارة على السرعة الابتدائية",
            keywords: ["سرعه","لاكتاز","حراره"],
            minHits: 2,
            forbidden: ["بسبب"],
          document: {"kind":"curve","axes":["سرعه","PH"],"comparisons":[["معتدل","طرف"]],"trends":[{"about":"معتدل","expect":["اعظميه","سرعه"]}],"values":[],"strictValues":false}
          }
        },
        E: {
          points: 2.5,
          ...
          minLength: 110,
          modelAnswer: "عند السليم يهضم اللاكتاز اللاكتوز في المعي الدقيق فلا يصل إلى الغليظ. عند المصاب ينقص اللاكتاز فيصل اللاكتوز إلى المعي الغليظ حيث تخمره البكتيريا فتتكون غازات وأحماض مسببة الانتفاخ والآلام.",
          rule: {
            prompt: "تفسير أعراض عدم التحمل",
        ...
        W: {
          ...
          placeholder: "في الختام...",
          minLength: 40,
          modelAnswer: "في الختام، الإنزيم وسيط حيوي نوعي يسرّع التفاعل في ظروف ملائمة دون أن يُستهلك، ونقصه يعطل الهضم.",
          rule: {
            prompt: "الخاتمة: مفهوم الإنزيم",
        ...
        S: {
          ...
          minLength: 60,
          modelAnswer: "تمثل الوثيقة نسبة الأكسجين بدلالة الزمن في الضوء والظلام. نلاحظ ارتفاع O2 في الضوء وعدم ارتفاعه في الظلام، ومنه نستنتج أن الضوء ضروري لطرح الأكسجين.",
          rule: {
            prompt: "استغلال ارتفاع O2 في الضوء",
            keywords: ["اكسجين","ضوء","ظلام"],
            minHits: 2,
            forbidden: ["بسبب"],
          document: {"kind":"curve","axes":["اكسجين","زمن"],"comparisons":[["ضوء","ظلام"]],"trends":[{"about":"ضوء","expect":["ارتفاع","اكسجين"]}],"values":[],"strictValues":false}
          }
        },
        E: {
          points: 4,
          ...
          minLength: 110,
          modelAnswer: "تمتص الأنظمة الضوئية الفوتونات فتتأكسد جزيئة الماء وينطلق O2 وتتحرر إلكترونات تختزل النواقل، فتتحول الطاقة الضوئية إلى طاقة كيميائية كامنة. تتأكد الفرضية.",
          rule: {
            prompt: "تفسير آلية طرح O2",
      ...
      sujets: [
        {
          ...
          pdf: null,
          pdfAvailable: false,
          pdfExternalUrl: "https://www.dzexams.com/uploads/sujets/officiels/bac/2017/dzexams-bac-sciences-2581269.pdf",
          pdfNote: "PDF non redistribué dans le dépôt. Page dzexams : https://www.dzexams.com/ar/annales/dFRNWk1JWkt2aC8vdFZtZVNMWGRwZz09. Session normale 2017. PDF dzexams محمي في العارض. Thèmes pédagogiques reconstruits.",
          title: "الموضوع الأول",
          exercises: [
          {
            number: 1,
        ...
        N: {
          ...
          placeholder: "صياغة المشكل العلمي...",
          minLength: 40,
          modelAnswer: "المشكل العلمي: كيف تتدخل الآليات المرتبطة بـ الشفرة الوراثية والترجمة في الظاهرة المدروسة؟",
          rule: {
            prompt: "تأطير الإشكالية حول: الشفرة الوراثية والترجمة",
        ...
        S: {
          ...
          minLength: 40,
          modelAnswer: "تمثل الوثيقة تغيرات رامزه بدلالة الزمن مقارنة بـ ترجمه. نلاحظ تغيرا واضحا في رامزه مقارنة بالشاهد، ومنه نستنتج علاقة مباشرة مع ترجمه.",
          rule: {
            prompt: "استغلال الوثيقة المتعلقة بـ الشفرة الوراثية والترجمة",
            keywords: ["رامزه","ترجمه","نلاحظ"],
            minHits: 2,
            forbidden: ["بسبب"],
          document: {"kind":"curve","axes":["رامزه","زمن"],"comparisons":[["رامزه","ترجمه"]],"trends":[{"about":"رامزه","expect":["رامزه","ترجمه"]}],"values":[],"strictValues":false}
          }
        },
        E: {
          points: 2,
          ...
          minLength: 120,
          modelAnswer: "يعود ذلك إلى تدخل رامزه وترجمه عبر آلية دقيقة تؤدي إلى ARNm، فتتغير الوظيفة النهائية للظاهرة المدروسة.",
          rule: {
            prompt: "تفسير الآلية المرتبطة بـ الشفرة الوراثية والترجمة",
        ...
        N: {
          ...
          placeholder: "صياغة المشكل العلمي...",
          minLength: 40,
          modelAnswer: "المشكل العلمي: كيف تتدخل الآليات المرتبطة بـ البنية الفراغية للبروتين في الظاهرة المدروسة؟",
          rule: {
            prompt: "تأطير الإشكالية حول: البنية الفراغية للبروتين",
            keywords: ["بنيه","روابط"],
            minHits: 2,
        ...
        S: {
          ...
          placeholder: "نلاحظ... بينما... ومنه نستنتج...",
          minLength: 90,
          modelAnswer: "تمثل الوثيقة تغيرات بنيه بدلالة الزمن مقارنة بـ روابط. نلاحظ تغيرا واضحا في بنيه مقارنة بالشاهد، ومنه نستنتج علاقة مباشرة مع روابط.",
          rule: {
            prompt: "استغلال الوثيقة المتعلقة بـ البنية الفراغية للبروتين",
            keywords: ["بنيه","روابط","نلاحظ"],
            minHits: 2,
            forbidden: ["بسبب"],
          document: {"kind":"curve","axes":["بنيه","زمن"],"comparisons":[["بنيه","روابط"]],"trends":[{"about":"بنيه","expect":["بنيه","روابط"]}],"values":[],"strictValues":false}
          }
        },
        E: {
          points: 2.5,
          ...
          placeholder: "يعود ذلك إلى...",
          minLength: 110,
          modelAnswer: "يعود ذلك إلى تدخل بنيه وروابط عبر آلية دقيقة تؤدي إلى طفره، فتتغير الوظيفة النهائية للظاهرة المدروسة.",
          rule: {
            prompt: "تفسير الآلية المرتبطة بـ البنية الفراغية للبروتين",
        ...
        N: {
          ...
          placeholder: "صياغة المشكل العلمي...",
          minLength: 30,
          modelAnswer: "المشكل العلمي: كيف تتدخل الآليات المرتبطة بـ المرحلة الكيميائية الضوئية في الظاهرة المدروسة؟",
          rule: {
            prompt: "تأطير الإشكالية حول: المرحلة الكيميائية الضوئية",
        ...
        S: {
          ...
          placeholder: "نلاحظ... بينما... ومنه نستنتج...",
          minLength: 60,
          modelAnswer: "تمثل الوثيقة تغيرات تيلاكوئيد بدلالة الزمن مقارنة بـ ضوء. نلاحظ تغيرا واضحا في تيلاكوئيد مقارنة بالشاهد، ومنه نستنتج علاقة مباشرة مع ضوء.",
          rule: {
            prompt: "استغلال الوثيقة المتعلقة بـ المرحلة الكيميائية الضوئية",
            keywords: ["تيلاكوئيد","ضوء","نلاحظ"],
            minHits: 2,
            forbidden: ["بسبب"],
          document: {"kind":"curve","axes":["تيلاكوئيد","زمن"],"comparisons":[["تيلاكوئيد","ضوء"]],"trends":[{"about":"تيلاكوئيد","expect":["تيلاكوئيد","ضوء"]}],"values":[],"strictValues":false}
          }
        },
        E: {
          points: 4,
          ...
          placeholder: "يعود ذلك إلى...",
          minLength: 110,
          modelAnswer: "يعود ذلك إلى تدخل تيلاكوئيد وضوء عبر آلية دقيقة تؤدي إلى اكسجين، فتتغير الوظيفة النهائية للظاهرة المدروسة.",
          rule: {
            prompt: "تفسير الآلية المرتبطة بـ المرحلة الكيميائية الضوئية",
        ...
        S: {
          ...
          placeholder: "نلاحظ... بينما... ومنه نستنتج...",
          minLength: 40,
          modelAnswer: "تمثل الوثيقة تغيرات CMH بدلالة الزمن مقارنة بـ ذات. نلاحظ تغيرا واضحا في CMH مقارنة بالشاهد، ومنه نستنتج علاقة مباشرة مع ذات.",
          rule: {
            prompt: "استغلال الوثيقة المتعلقة بـ الذات واللاذات",
            keywords: ["CMH","ذات","نلاحظ"],
            minHits: 2,
            forbidden: ["بسبب"],
          document: {"kind":"curve","axes":["CMH","زمن"],"comparisons":[["CMH","ذات"]],"trends":[{"about":"CMH","expect":["CMH","ذات"]}],"values":[],"strictValues":false}
          }
        },
        E: {
          points: 2,
          ...
          placeholder: "يعود ذلك إلى...",
          minLength: 120,
          modelAnswer: "يعود ذلك إلى تدخل CMH وذات عبر آلية دقيقة تؤدي إلى لاذات، فتتغير الوظيفة النهائية للظاهرة المدروسة.",
          rule: {
            prompt: "تفسير الآلية المرتبطة بـ الذات واللاذات",
        ...
        N: {
          ...
          placeholder: "صياغة المشكل العلمي...",
          minLength: 40,
          modelAnswer: "المشكل العلمي: كيف تتدخل الآليات المرتبطة بـ تأثير pH على النشاط الإنزيمي في الظاهرة المدروسة؟",
          rule: {
            prompt: "تأطير الإشكالية حول: تأثير pH على النشاط الإنزيمي",
            keywords: ["PH","موقع"],
            minHits: 2,
        ...
        S: {
          ...
          placeholder: "نلاحظ... بينما... ومنه نستنتج...",
          minLength: 90,
          modelAnswer: "تمثل الوثيقة تغيرات PH بدلالة الزمن مقارنة بـ موقع. نلاحظ تغيرا واضحا في PH مقارنة بالشاهد، ومنه نستنتج علاقة مباشرة مع موقع.",
          rule: {
            prompt: "استغلال الوثيقة المتعلقة بـ تأثير pH على النشاط الإنزيمي",
            keywords: ["PH","موقع","نلاحظ"],
            minHits: 2,
            forbidden: ["بسبب"],
          document: {"kind":"curve","axes":["PH","زمن"],"comparisons":[["PH","موقع"]],"trends":[{"about":"PH","expect":["PH","موقع"]}],"values":[],"strictValues":false}
          }
        },
        E: {
          points: 2.5,
          ...
          placeholder: "يعود ذلك إلى...",
          minLength: 110,
          modelAnswer: "يعود ذلك إلى تدخل PH وموقع عبر آلية دقيقة تؤدي إلى نشاط، فتتغير الوظيفة النهائية للظاهرة المدروسة.",
          rule: {
            prompt: "تفسير الآلية المرتبطة بـ تأثير pH على النشاط الإنزيمي",
        ...
        N: {
          ...
          placeholder: "صياغة المشكل العلمي...",
          minLength: 30,
          modelAnswer: "المشكل العلمي: كيف تتدخل الآليات المرتبطة بـ فيروس VIH والمناعة في الظاهرة المدروسة؟",
          rule: {
            prompt: "تأطير الإشكالية حول: فيروس VIH والمناعة",
            keywords: ["VIH","LT4"],
            minHits: 2,
        ...
        S: {
          ...
          placeholder: "نلاحظ... بينما... ومنه نستنتج...",
          minLength: 60,
          modelAnswer: "تمثل الوثيقة تغيرات VIH بدلالة الزمن مقارنة بـ LT4. نلاحظ تغيرا واضحا في VIH مقارنة بالشاهد، ومنه نستنتج علاقة مباشرة مع LT4.",
          rule: {
            prompt: "استغلال الوثيقة المتعلقة بـ فيروس VIH والمناعة",
            keywords: ["VIH","LT4","نلاحظ"],
            minHits: 2,
            forbidden: ["بسبب"],
          document: {"kind":"curve","axes":["VIH","زمن"],"comparisons":[["VIH","LT4"]],"trends":[{"about":"VIH","expect":["VIH","LT4"]}],"values":[],"strictValues":false}
          }
        },
        E: {
          points: 4,
          ...
          placeholder: "يعود ذلك إلى...",
          minLength: 110,
          modelAnswer: "يعود ذلك إلى تدخل VIH وLT4 عبر آلية دقيقة تؤدي إلى مناعه، فتتغير الوظيفة النهائية للظاهرة المدروسة.",
          rule: {
            prompt: "تفسير الآلية المرتبطة بـ فيروس VIH والمناعة",
      ...
      sujets: [
        {
          ...
          pdfNote: "PDF non redistribué dans le dépôt. Page dzexams : https://www.dzexams.com/ar/annales/M09NK2ZYVHFzQXg3KzZHazBaTk5IUT09. 2016 : session de remplacement retenue. Thèmes pédagogiques reconstruits.",
          title: "الموضوع الأول",
          exercises: [
          {
            number: 1,
        ...
        N: {
          ...
          placeholder: "صياغة المشكل العلمي...",
          minLength: 40,
          modelAnswer: "المشكل العلمي: كيف تتدخل الآليات المرتبطة بـ الاستنساخ داخل النواة في الظاهرة المدروسة؟",
          rule: {
            prompt: "تأطير الإشكالية حول: الاستنساخ داخل النواة",
        ...
        S: {
          ...
          placeholder: "نلاحظ... بينما... ومنه نستنتج...",
          minLength: 40,
          modelAnswer: "تمثل الوثيقة تغيرات استنساخ بدلالة الزمن مقارنة بـ بوليميراز. نلاحظ تغيرا واضحا في استنساخ مقارنة بالشاهد، ومنه نستنتج علاقة مباشرة مع بوليميراز.",
          rule: {
            prompt: "استغلال الوثيقة المتعلقة بـ الاستنساخ داخل النواة",
            keywords: ["استنساخ","بوليميراز","نلاحظ"],
            minHits: 2,
            forbidden: ["بسبب"],
          document: {"kind":"curve","axes":["استنساخ","زمن"],"comparisons":[["استنساخ","بوليميراز"]],"trends":[{"about":"استنساخ","expect":["استنساخ","بوليميراز"]}],"values":[],"strictValues":false}
          }
        },
        E: {
          points: 2,
          ...
          placeholder: "يعود ذلك إلى...",
          minLength: 120,
          modelAnswer: "يعود ذلك إلى تدخل استنساخ وبوليميراز عبر آلية دقيقة تؤدي إلى نواه، فتتغير الوظيفة النهائية للظاهرة المدروسة.",
          rule: {
            prompt: "تفسير الآلية المرتبطة بـ الاستنساخ داخل النواة",
        ...
        N: {
          ...
          placeholder: "صياغة المشكل العلمي...",
          minLength: 40,
          modelAnswer: "المشكل العلمي: كيف تتدخل الآليات المرتبطة بـ التخصص الوظيفي للإنزيم في الظاهرة المدروسة؟",
          rule: {
            prompt: "تأطير الإشكالية حول: التخصص الوظيفي للإنزيم",
        ...
        S: {
          ...
          placeholder: "نلاحظ... بينما... ومنه نستنتج...",
          minLength: 90,
          modelAnswer: "تمثل الوثيقة تغيرات انزيم بدلالة الزمن مقارنة بـ ركيزه. نلاحظ تغيرا واضحا في انزيم مقارنة بالشاهد، ومنه نستنتج علاقة مباشرة مع ركيزه.",
          rule: {
            prompt: "استغلال الوثيقة المتعلقة بـ التخصص الوظيفي للإنزيم",
            keywords: ["انزيم","ركيزه","نلاحظ"],
            minHits: 2,
            forbidden: ["بسبب"],
          document: {"kind":"curve","axes":["انزيم","زمن"],"comparisons":[["انزيم","ركيزه"]],"trends":[{"about":"انزيم","expect":["انزيم","ركيزه"]}],"values":[],"strictValues":false}
          }
        },
        E: {
          points: 2.5,
          ...
          placeholder: "يعود ذلك إلى...",
          minLength: 110,
          modelAnswer: "يعود ذلك إلى تدخل انزيم وركيزه عبر آلية دقيقة تؤدي إلى تخصص، فتتغير الوظيفة النهائية للظاهرة المدروسة.",
          rule: {
            prompt: "تفسير الآلية المرتبطة بـ التخصص الوظيفي للإنزيم",
        ...
        N: {
          ...
          placeholder: "صياغة المشكل العلمي...",
          minLength: 30,
          modelAnswer: "المشكل العلمي: كيف تتدخل الآليات المرتبطة بـ المناعة الخلطية في الظاهرة المدروسة؟",
          rule: {
            prompt: "تأطير الإشكالية حول: المناعة الخلطية",
        ...
        S: {
          ...
          placeholder: "نلاحظ... بينما... ومنه نستنتج...",
          minLength: 60,
          modelAnswer: "تمثل الوثيقة تغيرات مضاده بدلالة الزمن مقارنة بـ بلاسموسيت. نلاحظ تغيرا واضحا في مضاده مقارنة بالشاهد، ومنه نستنتج علاقة مباشرة مع بلاسموسيت.",
          rule: {
            prompt: "استغلال الوثيقة المتعلقة بـ المناعة الخلطية",
            keywords: ["مضاده","بلاسموسيت","نلاحظ"],
            minHits: 2,
            forbidden: ["بسبب"],
          document: {"kind":"curve","axes":["مضاده","زمن"],"comparisons":[["مضاده","بلاسموسيت"]],"trends":[{"about":"مضاده","expect":["مضاده","بلاسموسيت"]}],"values":[],"strictValues":false}
          }
        },
        E: {
          points: 4,
          ...
          placeholder: "يعود ذلك إلى...",
          minLength: 110,
          modelAnswer: "يعود ذلك إلى تدخل مضاده وبلاسموسيت عبر آلية دقيقة تؤدي إلى مستضد، فتتغير الوظيفة النهائية للظاهرة المدروسة.",
          rule: {
            prompt: "تفسير الآلية المرتبطة بـ المناعة الخلطية",
        ...
        N: {
          ...
          placeholder: "صياغة المشكل العلمي...",
          minLength: 40,
          modelAnswer: "المشكل العلمي: كيف تتدخل الآليات المرتبطة بـ المشبك الكيميائي في الظاهرة المدروسة؟",
          rule: {
            prompt: "تأطير الإشكالية حول: المشبك الكيميائي",
            keywords: ["مشبك","مبلغ"],
            minHits: 2,
        ...
        S: {
          ...
          placeholder: "نلاحظ... بينما... ومنه نستنتج...",
          minLength: 40,
          modelAnswer: "تمثل الوثيقة تغيرات مشبك بدلالة الزمن مقارنة بـ مبلغ. نلاحظ تغيرا واضحا في مشبك مقارنة بالشاهد، ومنه نستنتج علاقة مباشرة مع مبلغ.",
          rule: {
            prompt: "استغلال الوثيقة المتعلقة بـ المشبك الكيميائي",
            keywords: ["مشبك","مبلغ","نلاحظ"],
            minHits: 2,
            forbidden: ["بسبب"],
          document: {"kind":"curve","axes":["مشبك","زمن"],"comparisons":[["مشبك","مبلغ"]],"trends":[{"about":"مشبك","expect":["مشبك","مبلغ"]}],"values":[],"strictValues":false}
          }
        },
        E: {
          points: 2,
          ...
          placeholder: "يعود ذلك إلى...",
          minLength: 120,
          modelAnswer: "يعود ذلك إلى تدخل مشبك ومبلغ عبر آلية دقيقة تؤدي إلى كالسيوم، فتتغير الوظيفة النهائية للظاهرة المدروسة.",
          rule: {
            prompt: "تفسير الآلية المرتبطة بـ المشبك الكيميائي",
        ...
        S: {
          ...
          placeholder: "نلاحظ... بينما... ومنه نستنتج...",
          minLength: 90,
          modelAnswer: "تمثل الوثيقة تغيرات تخمر بدلالة الزمن مقارنة بـ تنفس. نلاحظ تغيرا واضحا في تخمر مقارنة بالشاهد، ومنه نستنتج علاقة مباشرة مع تنفس.",
          rule: {
            prompt: "استغلال الوثيقة المتعلقة بـ التخمر والتنفس",
            keywords: ["تخمر","تنفس","نلاحظ"],
            minHits: 2,
            forbidden: ["بسبب"],
          document: {"kind":"curve","axes":["تخمر","زمن"],"comparisons":[["تخمر","تنفس"]],"trends":[{"about":"تخمر","expect":["تخمر","تنفس"]}],"values":[],"strictValues":false}
          }
        },
        E: {
          points: 2.5,
          ...
          placeholder: "يعود ذلك إلى...",
          minLength: 110,
          modelAnswer: "يعود ذلك إلى تدخل تخمر وتنفس عبر آلية دقيقة تؤدي إلى ATP، فتتغير الوظيفة النهائية للظاهرة المدروسة.",
          rule: {
            prompt: "تفسير الآلية المرتبطة بـ التخمر والتنفس",
        ...
        N: {
          ...
          placeholder: "صياغة المشكل العلمي...",
          minLength: 30,
          modelAnswer: "المشكل العلمي: كيف تتدخل الآليات المرتبطة بـ بنية الكرة الأرضية في الظاهرة المدروسة؟",
          rule: {
            prompt: "تأطير الإشكالية حول: بنية الكرة الأرضية",
        ...
        S: {
          ...
          placeholder: "نلاحظ... بينما... ومنه نستنتج...",
          minLength: 60,
          modelAnswer: "تمثل الوثيقة تغيرات انقطاع بدلالة الزمن مقارنة بـ رداء. نلاحظ تغيرا واضحا في انقطاع مقارنة بالشاهد، ومنه نستنتج علاقة مباشرة مع رداء.",
          rule: {
            prompt: "استغلال الوثيقة المتعلقة بـ بنية الكرة الأرضية",
            keywords: ["انقطاع","رداء","نلاحظ"],
            minHits: 2,
            forbidden: ["بسبب"],
          document: {"kind":"curve","axes":["انقطاع","زمن"],"comparisons":[["انقطاع","رداء"]],"trends":[{"about":"انقطاع","expect":["انقطاع","رداء"]}],"values":[],"strictValues":false}
          }
        },
        E: {
          points: 4,
          ...
          placeholder: "يعود ذلك إلى...",
          minLength: 110,
          modelAnswer: "يعود ذلك إلى تدخل انقطاع ورداء عبر آلية دقيقة تؤدي إلى نواه، فتتغير الوظيفة النهائية للظاهرة المدروسة.",
          rule: {
            prompt: "تفسير الآلية المرتبطة بـ بنية الكرة الأرضية",
      ...
      sujets: [
        {
          ...
          pdf: null,
          pdfAvailable: false,
          pdfExternalUrl: "https://www.dzexams.com/uploads/sujets/officiels/bac/2015/dzexams-bac-sciences-5906014.pdf",
          pdfNote: "PDF non redistribué dans le dépôt. Page dzexams : https://www.dzexams.com/ar/annales/aTlRWGREbDN3Qit2cVdRaHNmK0FYQT09. 2015 : PDF dzexams دون طبقة نص قابلة للشهادة هنا. Thèmes pédagogiques reconstruits.",
          title: "الموضوع الأول",
          exercises: [
          {
            number: 1,
        ...
        N: {
          ...
          placeholder: "صياغة المشكل العلمي...",
          minLength: 40,
          modelAnswer: "المشكل العلمي: كيف تتدخل الآليات المرتبطة بـ الترجمة في الهيولى في الظاهرة المدروسة؟",
          rule: {
            prompt: "تأطير الإشكالية حول: الترجمة في الهيولى",
        ...
        S: {
          ...
          placeholder: "نلاحظ... بينما... ومنه نستنتج...",
          minLength: 40,
          modelAnswer: "تمثل الوثيقة تغيرات هيولي بدلالة الزمن مقارنة بـ ريبوزوم. نلاحظ تغيرا واضحا في هيولي مقارنة بالشاهد، ومنه نستنتج علاقة مباشرة مع ريبوزوم.",
          rule: {
            prompt: "استغلال الوثيقة المتعلقة بـ الترجمة في الهيولى",
            keywords: ["هيولي","ريبوزوم","نلاحظ"],
            minHits: 2,
            forbidden: ["بسبب"],
          document: {"kind":"curve","axes":["هيولي","زمن"],"comparisons":[["هيولي","ريبوزوم"]],"trends":[{"about":"هيولي","expect":["هيولي","ريبوزوم"]}],"values":[],"strictValues":false}
          }
        },
        E: {
          points: 2,
          ...
          placeholder: "يعود ذلك إلى...",
          minLength: 120,
          modelAnswer: "يعود ذلك إلى تدخل هيولي وريبوزوم عبر آلية دقيقة تؤدي إلى ARNt، فتتغير الوظيفة النهائية للظاهرة المدروسة.",
          rule: {
            prompt: "تفسير الآلية المرتبطة بـ الترجمة في الهيولى",
        ...
        N: {
          ...
          placeholder: "صياغة المشكل العلمي...",
          minLength: 40,
          modelAnswer: "المشكل العلمي: كيف تتدخل الآليات المرتبطة بـ الكربوكسي بيبتيداز والموقع الفعال في الظاهرة المدروسة؟",
          rule: {
            prompt: "تأطير الإشكالية حول: الكربوكسي بيبتيداز والموقع الفعال",
        ...
        S: {
          ...
          placeholder: "نلاحظ... بينما... ومنه نستنتج...",
          minLength: 90,
          modelAnswer: "تمثل الوثيقة تغيرات بيبتيداز بدلالة الزمن مقارنة بـ موقع. نلاحظ تغيرا واضحا في بيبتيداز مقارنة بالشاهد، ومنه نستنتج علاقة مباشرة مع موقع.",
          rule: {
            prompt: "استغلال الوثيقة المتعلقة بـ الكربوكسي بيبتيداز والموقع الفعال",
            keywords: ["بيبتيداز","موقع","نلاحظ"],
            minHits: 2,
            forbidden: ["بسبب"],
          document: {"kind":"curve","axes":["بيبتيداز","زمن"],"comparisons":[["بيبتيداز","موقع"]],"trends":[{"about":"بيبتيداز","expect":["بيبتيداز","موقع"]}],"values":[],"strictValues":false}
          }
        },
        E: {
          points: 2.5,
          prompt: "تفسير الآلية المرتبطة بـ الكربوكسي بيبتيداز والموقع الفعال",
          bacPrompt: "اشرح الآلية التي تفسر الكربوكسي بيبتيداز والموقع الفعال انطلاقا من الوثيقة ومعلوماتك.",
          ...RECON("Thème recoupé sur des sources secondaires et le programme 3AS, sans relecture visuelle d un PDF ministériel dans cette session. Wording reconstructed, non certifiable official. À confronter au PDF dzexams avant toute utilisation comme énoncé."),
          placeholder: "يعود ذلك إلى...",
          minLength: 110,
          modelAnswer: "يعود ذلك إلى تدخل بيبتيداز وموقع عبر آلية دقيقة تؤدي إلى فعال، فتتغير الوظيفة النهائية للظاهرة المدروسة.",
          rule: {
            prompt: "تفسير الآلية المرتبطة بـ الكربوكسي بيبتيداز والموقع الفعال",
        ...
        N: {
          ...
          placeholder: "صياغة المشكل العلمي...",
          minLength: 30,
          modelAnswer: "المشكل العلمي: كيف تتدخل الآليات المرتبطة بـ الاستجابة ضد VIH في الظاهرة المدروسة؟",
          rule: {
            prompt: "تأطير الإشكالية حول: الاستجابة ضد VIH",
            keywords: ["VIH","LT4"],
            minHits: 2,
        ...
        E: {
          ...
          placeholder: "يعود ذلك إلى...",
          minLength: 110,
          modelAnswer: "يعود ذلك إلى تدخل VIH وLT4 عبر آلية دقيقة تؤدي إلى مراقبه، فتتغير الوظيفة النهائية للظاهرة المدروسة.",
          rule: {
            prompt: "تفسير الآلية المرتبطة بـ الاستجابة ضد VIH",
        ...
        S: {
          ...
          placeholder: "نلاحظ... بينما... ومنه نستنتج...",
          minLength: 40,
          modelAnswer: "تمثل الوثيقة تغيرات مشبك بدلالة الزمن مقارنة بـ تاخير. نلاحظ تغيرا واضحا في مشبك مقارنة بالشاهد، ومنه نستنتج علاقة مباشرة مع تاخير.",
          rule: {
            prompt: "استغلال الوثيقة المتعلقة بـ النقل المشبكي",
            keywords: ["مشبك","تاخير","نلاحظ"],
            minHits: 2,
            forbidden: ["بسبب"],
          document: {"kind":"curve","axes":["مشبك","زمن"],"comparisons":[["مشبك","تاخير"]],"trends":[{"about":"مشبك","expect":["مشبك","تاخير"]}],"values":[],"strictValues":false}
          }
        },
        E: {
          points: 2,
          ...
          placeholder: "يعود ذلك إلى...",
          minLength: 120,
          modelAnswer: "يعود ذلك إلى تدخل مشبك وتاخير عبر آلية دقيقة تؤدي إلى مبلغ، فتتغير الوظيفة النهائية للظاهرة المدروسة.",
          rule: {
            prompt: "تفسير الآلية المرتبطة بـ النقل المشبكي",
        ...
        N: {
          ...
          placeholder: "صياغة المشكل العلمي...",
          minLength: 40,
          modelAnswer: "المشكل العلمي: كيف تتدخل الآليات المرتبطة بـ أنزيم RUBISCO وتثبيت CO2 في الظاهرة المدروسة؟",
          rule: {
            prompt: "تأطير الإشكالية حول: أنزيم RUBISCO وتثبيت CO2",
        ...
        S: {
          ...
          placeholder: "نلاحظ... بينما... ومنه نستنتج...",
          minLength: 90,
          modelAnswer: "تمثل الوثيقة تغيرات RUBISCO بدلالة الزمن مقارنة بـ تثبيت. نلاحظ تغيرا واضحا في RUBISCO مقارنة بالشاهد، ومنه نستنتج علاقة مباشرة مع تثبيت.",
          rule: {
            prompt: "استغلال الوثيقة المتعلقة بـ أنزيم RUBISCO وتثبيت CO2",
            keywords: ["RUBISCO","تثبيت","نلاحظ"],
            minHits: 2,
            forbidden: ["بسبب"],
          document: {"kind":"curve","axes":["RUBISCO","زمن"],"comparisons":[["RUBISCO","تثبيت"]],"trends":[{"about":"RUBISCO","expect":["RUBISCO","تثبيت"]}],"values":[],"strictValues":false}
          }
        },
        E: {
          points: 2.5,
          ...
          placeholder: "يعود ذلك إلى...",
          minLength: 110,
          modelAnswer: "يعود ذلك إلى تدخل RUBISCO وتثبيت عبر آلية دقيقة تؤدي إلى CO2، فتتغير الوظيفة النهائية للظاهرة المدروسة.",
          rule: {
            prompt: "تفسير الآلية المرتبطة بـ أنزيم RUBISCO وتثبيت CO2",
        ...
        N: {
          ...
          placeholder: "صياغة المشكل العلمي...",
          minLength: 30,
          modelAnswer: "المشكل العلمي: كيف تتدخل الآليات المرتبطة بـ الصفائح التكتونية في الظاهرة المدروسة؟",
          rule: {
            prompt: "تأطير الإشكالية حول: الصفائح التكتونية",
            keywords: ["صفائح","ظهره"],
            minHits: 2,
        ...
        S: {
          ...
          placeholder: "نلاحظ... بينما... ومنه نستنتج...",
          minLength: 60,
          modelAnswer: "تمثل الوثيقة تغيرات صفائح بدلالة الزمن مقارنة بـ ظهره. نلاحظ تغيرا واضحا في صفائح مقارنة بالشاهد، ومنه نستنتج علاقة مباشرة مع ظهره.",
          rule: {
            prompt: "استغلال الوثيقة المتعلقة بـ الصفائح التكتونية",
            keywords: ["صفائح","ظهره","نلاحظ"],
            minHits: 2,
            forbidden: ["بسبب"],
          document: {"kind":"curve","axes":["صفائح","زمن"],"comparisons":[["صفائح","ظهره"]],"trends":[{"about":"صفائح","expect":["صفائح","ظهره"]}],"values":[],"strictValues":false}
          }
        },
        E: {
          points: 4,
          ...
          placeholder: "يعود ذلك إلى...",
          minLength: 110,
          modelAnswer: "يعود ذلك إلى تدخل صفائح وظهره عبر آلية دقيقة تؤدي إلى غوص، فتتغير الوظيفة النهائية للظاهرة المدروسة.",
          rule: {
            prompt: "تفسير الآلية المرتبطة بـ الصفائح التكتونية",
      ...
      sujets: [
        {
          ...
          pdf: null,
          pdfAvailable: false,
          pdfExternalUrl: "https://www.dzexams.com/uploads/sujets/officiels/bac/2014/dzexams-bac-sciences-4380238.pdf",
          pdfNote: "PDF non redistribué dans le dépôt. Page dzexams : https://www.dzexams.com/ar/annales/SzdNaHlPbThvaEhSSUJjWDRsdUljdz09. 2014 : PDF dzexams دون طبقة نص قابلة للشهادة هنا. Thèmes pédagogiques reconstruits.",
          title: "الموضوع الأول",
          exercises: [
          {
            number: 1,
        ...
        N: {
          ...
          placeholder: "صياغة المشكل العلمي...",
          minLength: 40,
          modelAnswer: "المشكل العلمي: كيف تتدخل الآليات المرتبطة بـ مراحل تركيب البروتين في الظاهرة المدروسة؟",
          rule: {
            prompt: "تأطير الإشكالية حول: مراحل تركيب البروتين",
        ...
        S: {
          ...
          placeholder: "نلاحظ... بينما... ومنه نستنتج...",
          minLength: 40,
          modelAnswer: "تمثل الوثيقة تغيرات استنساخ بدلالة الزمن مقارنة بـ ترجمه. نلاحظ تغيرا واضحا في استنساخ مقارنة بالشاهد، ومنه نستنتج علاقة مباشرة مع ترجمه.",
          rule: {
            prompt: "استغلال الوثيقة المتعلقة بـ مراحل تركيب البروتين",
            keywords: ["استنساخ","ترجمه","نلاحظ"],
            minHits: 2,
            forbidden: ["بسبب"],
          document: {"kind":"curve","axes":["استنساخ","زمن"],"comparisons":[["استنساخ","ترجمه"]],"trends":[{"about":"استنساخ","expect":["استنساخ","ترجمه"]}],"values":[],"strictValues":false}
          }
        },
        E: {
          points: 2,
          ...
          placeholder: "يعود ذلك إلى...",
          minLength: 120,
          modelAnswer: "يعود ذلك إلى تدخل استنساخ وترجمه عبر آلية دقيقة تؤدي إلى بروتين، فتتغير الوظيفة النهائية للظاهرة المدروسة.",
          rule: {
            prompt: "تفسير الآلية المرتبطة بـ مراحل تركيب البروتين",
        ...
        N: {
          ...
          placeholder: "صياغة المشكل العلمي...",
          minLength: 40,
          modelAnswer: "المشكل العلمي: كيف تتدخل الآليات المرتبطة بـ التثبيط الإنزيمي في الظاهرة المدروسة؟",
          rule: {
            prompt: "تأطير الإشكالية حول: التثبيط الإنزيمي",
            keywords: ["تثبيط","موقع"],
            minHits: 2,
        ...
        S: {
          ...
          placeholder: "نلاحظ... بينما... ومنه نستنتج...",
          minLength: 90,
          modelAnswer: "تمثل الوثيقة تغيرات تثبيط بدلالة الزمن مقارنة بـ موقع. نلاحظ تغيرا واضحا في تثبيط مقارنة بالشاهد، ومنه نستنتج علاقة مباشرة مع موقع.",
          rule: {
            prompt: "استغلال الوثيقة المتعلقة بـ التثبيط الإنزيمي",
            keywords: ["تثبيط","موقع","نلاحظ"],
            minHits: 2,
            forbidden: ["بسبب"],
          document: {"kind":"curve","axes":["تثبيط","زمن"],"comparisons":[["تثبيط","موقع"]],"trends":[{"about":"تثبيط","expect":["تثبيط","موقع"]}],"values":[],"strictValues":false}
          }
        },
        E: {
          points: 2.5,
          ...
          placeholder: "يعود ذلك إلى...",
          minLength: 110,
          modelAnswer: "يعود ذلك إلى تدخل تثبيط وموقع عبر آلية دقيقة تؤدي إلى ركيزه، فتتغير الوظيفة النهائية للظاهرة المدروسة.",
          rule: {
            prompt: "تفسير الآلية المرتبطة بـ التثبيط الإنزيمي",
        ...
        N: {
          ...
          placeholder: "صياغة المشكل العلمي...",
          minLength: 30,
          modelAnswer: "المشكل العلمي: كيف تتدخل الآليات المرتبطة بـ الدفاع عن الذات في الظاهرة المدروسة؟",
          rule: {
            prompt: "تأطير الإشكالية حول: الدفاع عن الذات",
            keywords: ["ذات","لاذات"],
            minHits: 2,
        ...
        S: {
          ...
          placeholder: "نلاحظ... بينما... ومنه نستنتج...",
          minLength: 60,
          modelAnswer: "تمثل الوثيقة تغيرات ذات بدلالة الزمن مقارنة بـ لاذات. نلاحظ تغيرا واضحا في ذات مقارنة بالشاهد، ومنه نستنتج علاقة مباشرة مع لاذات.",
          rule: {
            prompt: "استغلال الوثيقة المتعلقة بـ الدفاع عن الذات",
            keywords: ["ذات","لاذات","نلاحظ"],
            minHits: 2,
            forbidden: ["بسبب"],
          document: {"kind":"curve","axes":["ذات","زمن"],"comparisons":[["ذات","لاذات"]],"trends":[{"about":"ذات","expect":["ذات","لاذات"]}],"values":[],"strictValues":false}
          }
        },
        E: {
          points: 4,
          ...
          placeholder: "يعود ذلك إلى...",
          minLength: 110,
          modelAnswer: "يعود ذلك إلى تدخل ذات ولاذات عبر آلية دقيقة تؤدي إلى تعرف، فتتغير الوظيفة النهائية للظاهرة المدروسة.",
          rule: {
            prompt: "تفسير الآلية المرتبطة بـ الدفاع عن الذات",
        ...
        S: {
          ...
          placeholder: "نلاحظ... بينما... ومنه نستنتج...",
          minLength: 40,
          modelAnswer: "تمثل الوثيقة تغيرات راحه بدلالة الزمن مقارنة بـ مضخه. نلاحظ تغيرا واضحا في راحه مقارنة بالشاهد، ومنه نستنتج علاقة مباشرة مع مضخه.",
          rule: {
            prompt: "استغلال الوثيقة المتعلقة بـ كمون الراحة",
            keywords: ["راحه","مضخه","نلاحظ"],
            minHits: 2,
            forbidden: ["بسبب"],
          document: {"kind":"curve","axes":["راحه","زمن"],"comparisons":[["راحه","مضخه"]],"trends":[{"about":"راحه","expect":["راحه","مضخه"]}],"values":[],"strictValues":false}
          }
        },
        E: {
          points: 2,
          ...
          placeholder: "يعود ذلك إلى...",
          minLength: 120,
          modelAnswer: "يعود ذلك إلى تدخل راحه ومضخه عبر آلية دقيقة تؤدي إلى شوارد، فتتغير الوظيفة النهائية للظاهرة المدروسة.",
          rule: {
            prompt: "تفسير الآلية المرتبطة بـ كمون الراحة",
        ...
        N: {
          ...
          placeholder: "صياغة المشكل العلمي...",
          minLength: 40,
          modelAnswer: "المشكل العلمي: كيف تتدخل الآليات المرتبطة بـ تحويل الطاقة في الميتوكوندري في الظاهرة المدروسة؟",
          rule: {
            prompt: "تأطير الإشكالية حول: تحويل الطاقة في الميتوكوندري",
        ...
        S: {
          ...
          placeholder: "نلاحظ... بينما... ومنه نستنتج...",
          minLength: 90,
          modelAnswer: "تمثل الوثيقة تغيرات ميتوكوندري بدلالة الزمن مقارنة بـ نواقل. نلاحظ تغيرا واضحا في ميتوكوندري مقارنة بالشاهد، ومنه نستنتج علاقة مباشرة مع نواقل.",
          rule: {
            prompt: "استغلال الوثيقة المتعلقة بـ تحويل الطاقة في الميتوكوندري",
            keywords: ["ميتوكوندري","نواقل","نلاحظ"],
            minHits: 2,
            forbidden: ["بسبب"],
          document: {"kind":"curve","axes":["ميتوكوندري","زمن"],"comparisons":[["ميتوكوندري","نواقل"]],"trends":[{"about":"ميتوكوندري","expect":["ميتوكوندري","نواقل"]}],"values":[],"strictValues":false}
          }
        },
        E: {
          points: 2.5,
          ...
          placeholder: "يعود ذلك إلى...",
          minLength: 110,
          modelAnswer: "يعود ذلك إلى تدخل ميتوكوندري ونواقل عبر آلية دقيقة تؤدي إلى ATP، فتتغير الوظيفة النهائية للظاهرة المدروسة.",
          rule: {
            prompt: "تفسير الآلية المرتبطة بـ تحويل الطاقة في الميتوكوندري",
        ...
        N: {
          ...
          placeholder: "صياغة المشكل العلمي...",
          minLength: 30,
          modelAnswer: "المشكل العلمي: كيف تتدخل الآليات المرتبطة بـ النشاط التكتوني في الظاهرة المدروسة؟",
          rule: {
            prompt: "تأطير الإشكالية حول: النشاط التكتوني",
            keywords: ["زلزال","حدود"],
            minHits: 2,
        ...
        S: {
          ...
          placeholder: "نلاحظ... بينما... ومنه نستنتج...",
          minLength: 60,
          modelAnswer: "تمثل الوثيقة تغيرات زلزال بدلالة الزمن مقارنة بـ حدود. نلاحظ تغيرا واضحا في زلزال مقارنة بالشاهد، ومنه نستنتج علاقة مباشرة مع حدود.",
          rule: {
            prompt: "استغلال الوثيقة المتعلقة بـ النشاط التكتوني",
            keywords: ["زلزال","حدود","نلاحظ"],
            minHits: 2,
            forbidden: ["بسبب"],
          document: {"kind":"curve","axes":["زلزال","زمن"],"comparisons":[["زلزال","حدود"]],"trends":[{"about":"زلزال","expect":["زلزال","حدود"]}],"values":[],"strictValues":false}
          }
        },
        E: {
          points: 4,
          ...
          placeholder: "يعود ذلك إلى...",
          minLength: 110,
          modelAnswer: "يعود ذلك إلى تدخل زلزال وحدود عبر آلية دقيقة تؤدي إلى صفائح، فتتغير الوظيفة النهائية للظاهرة المدروسة.",
          rule: {
            prompt: "تفسير الآلية المرتبطة بـ النشاط التكتوني",
      ...
      sujets: [
        {
          ...
          pdf: null,
          pdfAvailable: false,
          pdfExternalUrl: "https://www.dzexams.com/uploads/sujets/officiels/bac/2013/dzexams-bac-sciences-4463279.pdf",
          pdfNote: "PDF non redistribué dans le dépôt. Page dzexams : https://www.dzexams.com/ar/annales/bjdJbVBZMHFKeUZTcExKSEw4REVNQT09. 2013 : PDF dzexams محمي في العارض. Thèmes pédagogiques reconstruits.",
          title: "الموضوع الأول",
          exercises: [
          {
            number: 1,
        ...
        S: {
          ...
          placeholder: "نلاحظ... بينما... ومنه نستنتج...",
          minLength: 40,
          modelAnswer: "تمثل الوثيقة تغيرات مورثه بدلالة الزمن مقارنة بـ نسخ. نلاحظ تغيرا واضحا في مورثه مقارنة بالشاهد، ومنه نستنتج علاقة مباشرة مع نسخ.",
          rule: {
            prompt: "استغلال الوثيقة المتعلقة بـ النسخ والترجمة",
            keywords: ["مورثه","نسخ","نلاحظ"],
            minHits: 2,
            forbidden: ["بسبب"],
          document: {"kind":"curve","axes":["مورثه","زمن"],"comparisons":[["مورثه","نسخ"]],"trends":[{"about":"مورثه","expect":["مورثه","نسخ"]}],"values":[],"strictValues":false}
          }
        },
        E: {
          points: 2,
          ...
          placeholder: "يعود ذلك إلى...",
          minLength: 120,
          modelAnswer: "يعود ذلك إلى تدخل مورثه ونسخ عبر آلية دقيقة تؤدي إلى ترجمه، فتتغير الوظيفة النهائية للظاهرة المدروسة.",
          rule: {
            prompt: "تفسير الآلية المرتبطة بـ النسخ والترجمة",
        ...
        N: {
          ...
          placeholder: "صياغة المشكل العلمي...",
          minLength: 40,
          modelAnswer: "المشكل العلمي: كيف تتدخل الآليات المرتبطة بـ الموقع الفعال للإنزيم في الظاهرة المدروسة؟",
          rule: {
            prompt: "تأطير الإشكالية حول: الموقع الفعال للإنزيم",
        ...
        S: {
          ...
          placeholder: "نلاحظ... بينما... ومنه نستنتج...",
          minLength: 90,
          modelAnswer: "تمثل الوثيقة تغيرات امينيه بدلالة الزمن مقارنة بـ موقع. نلاحظ تغيرا واضحا في امينيه مقارنة بالشاهد، ومنه نستنتج علاقة مباشرة مع موقع.",
          rule: {
            prompt: "استغلال الوثيقة المتعلقة بـ الموقع الفعال للإنزيم",
            keywords: ["امينيه","موقع","نلاحظ"],
            minHits: 2,
            forbidden: ["بسبب"],
          document: {"kind":"curve","axes":["امينيه","زمن"],"comparisons":[["امينيه","موقع"]],"trends":[{"about":"امينيه","expect":["امينيه","موقع"]}],"values":[],"strictValues":false}
          }
        },
        E: {
          points: 2.5,
          ...
          placeholder: "يعود ذلك إلى...",
          minLength: 110,
          modelAnswer: "يعود ذلك إلى تدخل امينيه وموقع عبر آلية دقيقة تؤدي إلى تخصص، فتتغير الوظيفة النهائية للظاهرة المدروسة.",
          rule: {
            prompt: "تفسير الآلية المرتبطة بـ الموقع الفعال للإنزيم",
        ...
        N: {
          ...
          placeholder: "صياغة المشكل العلمي...",
          minLength: 30,
          modelAnswer: "المشكل العلمي: كيف تتدخل الآليات المرتبطة بـ الأجسام المضادة في الظاهرة المدروسة؟",
          rule: {
            prompt: "تأطير الإشكالية حول: الأجسام المضادة",
            keywords: ["مضاده","مولد"],
            minHits: 2,
        ...
        S: {
          ...
          placeholder: "نلاحظ... بينما... ومنه نستنتج...",
          minLength: 60,
          modelAnswer: "تمثل الوثيقة تغيرات مضاده بدلالة الزمن مقارنة بـ مولد. نلاحظ تغيرا واضحا في مضاده مقارنة بالشاهد، ومنه نستنتج علاقة مباشرة مع مولد.",
          rule: {
            prompt: "استغلال الوثيقة المتعلقة بـ الأجسام المضادة",
            keywords: ["مضاده","مولد","نلاحظ"],
            minHits: 2,
            forbidden: ["بسبب"],
          document: {"kind":"curve","axes":["مضاده","زمن"],"comparisons":[["مضاده","مولد"]],"trends":[{"about":"مضاده","expect":["مضاده","مولد"]}],"values":[],"strictValues":false}
          }
        },
        E: {
          points: 4,
          ...
          placeholder: "يعود ذلك إلى...",
          minLength: 110,
          modelAnswer: "يعود ذلك إلى تدخل مضاده ومولد عبر آلية دقيقة تؤدي إلى ضد، فتتغير الوظيفة النهائية للظاهرة المدروسة.",
          rule: {
            prompt: "تفسير الآلية المرتبطة بـ الأجسام المضادة",
        ...
        S: {
          ...
          placeholder: "نلاحظ... بينما... ومنه نستنتج...",
          minLength: 40,
          modelAnswer: "تمثل الوثيقة تغيرات عمل بدلالة الزمن مقارنة بـ قنوات. نلاحظ تغيرا واضحا في عمل مقارنة بالشاهد، ومنه نستنتج علاقة مباشرة مع قنوات.",
          rule: {
            prompt: "استغلال الوثيقة المتعلقة بـ كمون العمل",
            keywords: ["عمل","قنوات","نلاحظ"],
            minHits: 2,
            forbidden: ["بسبب"],
          document: {"kind":"curve","axes":["عمل","زمن"],"comparisons":[["عمل","قنوات"]],"trends":[{"about":"عمل","expect":["عمل","قنوات"]}],"values":[],"strictValues":false}
          }
        },
        E: {
          points: 2,
          ...
          placeholder: "يعود ذلك إلى...",
          minLength: 120,
          modelAnswer: "يعود ذلك إلى تدخل عمل وقنوات عبر آلية دقيقة تؤدي إلى فولطيه، فتتغير الوظيفة النهائية للظاهرة المدروسة.",
          rule: {
            prompt: "تفسير الآلية المرتبطة بـ كمون العمل",
        ...
        N: {
          ...
          placeholder: "صياغة المشكل العلمي...",
          minLength: 40,
          modelAnswer: "المشكل العلمي: كيف تتدخل الآليات المرتبطة بـ ATP في الميتوكوندري في الظاهرة المدروسة؟",
          rule: {
            prompt: "تأطير الإشكالية حول: ATP في الميتوكوندري",
        ...
        S: {
          ...
          placeholder: "نلاحظ... بينما... ومنه نستنتج...",
          minLength: 90,
          modelAnswer: "تمثل الوثيقة تغيرات بروتون بدلالة الزمن مقارنة بـ سنتاز. نلاحظ تغيرا واضحا في بروتون مقارنة بالشاهد، ومنه نستنتج علاقة مباشرة مع سنتاز.",
          rule: {
            prompt: "استغلال الوثيقة المتعلقة بـ ATP في الميتوكوندري",
            keywords: ["بروتون","سنتاز","نلاحظ"],
            minHits: 2,
            forbidden: ["بسبب"],
          document: {"kind":"curve","axes":["بروتون","زمن"],"comparisons":[["بروتون","سنتاز"]],"trends":[{"about":"بروتون","expect":["بروتون","سنتاز"]}],"values":[],"strictValues":false}
          }
        },
        E: {
          points: 2.5,
          ...
          placeholder: "يعود ذلك إلى...",
          minLength: 110,
          modelAnswer: "يعود ذلك إلى تدخل بروتون وسنتاز عبر آلية دقيقة تؤدي إلى ATP، فتتغير الوظيفة النهائية للظاهرة المدروسة.",
          rule: {
            prompt: "تفسير الآلية المرتبطة بـ ATP في الميتوكوندري",
        ...
        N: {
          ...
          placeholder: "صياغة المشكل العلمي...",
          minLength: 30,
          modelAnswer: "المشكل العلمي: كيف تتدخل الآليات المرتبطة بـ الحمل الحراري والصفائح في الظاهرة المدروسة؟",
          rule: {
            prompt: "تأطير الإشكالية حول: الحمل الحراري والصفائح",
            keywords: ["حمل","حراري"],
            minHits: 2,
        ...
        S: {
          ...
          placeholder: "نلاحظ... بينما... ومنه نستنتج...",
          minLength: 60,
          modelAnswer: "تمثل الوثيقة تغيرات حمل بدلالة الزمن مقارنة بـ حراري. نلاحظ تغيرا واضحا في حمل مقارنة بالشاهد، ومنه نستنتج علاقة مباشرة مع حراري.",
          rule: {
            prompt: "استغلال الوثيقة المتعلقة بـ الحمل الحراري والصفائح",
            keywords: ["حمل","حراري","نلاحظ"],
            minHits: 2,
            forbidden: ["بسبب"],
          document: {"kind":"curve","axes":["حمل","زمن"],"comparisons":[["حمل","حراري"]],"trends":[{"about":"حمل","expect":["حمل","حراري"]}],"values":[],"strictValues":false}
          }
        },
        E: {
          points: 4,
          ...
          placeholder: "يعود ذلك إلى...",
          minLength: 110,
          modelAnswer: "يعود ذلك إلى تدخل حمل وحراري عبر آلية دقيقة تؤدي إلى رداء، فتتغير الوظيفة النهائية للظاهرة المدروسة.",
          rule: {
            prompt: "تفسير الآلية المرتبطة بـ الحمل الحراري والصفائح",
